...
UTime_Stuttering_Graph_C__pf517162645::UTime_Stuttering_Graph_C__pf517162645(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void UTime_Stuttering_Graph_C__pf517162645::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UTime_Stuttering_Graph_C__pf517162645::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__7 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_6"), (EObjectFlags)0x00280008);
	__Local__7->LayoutData.Offsets.Right = 1625.970459f;
	__Local__7->LayoutData.Offsets.Bottom = 779.638550f;
	__Local__7->ZOrder = -1;
	__Local__7->Parent = __Local__1;
	auto __Local__8 = NewObject<UImage>(__Local__0, TEXT("Image_165"), (EObjectFlags)0x00280008);
	__Local__8->ColorAndOpacity = FLinearColor(0.062500, 0.062500, 0.062500, 1.000000);
	...
	__Local__9->LayoutData.Offsets.Left = 285.000000f;
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"0349D0D5483B2DAC0826F29D7A8F558F\", \"1\")")	);
	...
	__Local__12->LayoutData.Offsets.Left = 585.000000f;
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"0220C6A44F27669622819DA7BBB433A6\", \"2\")")	);
	...
	__Local__15->LayoutData.Offsets.Left = 885.000000f;
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"54CC15174F06A574DE902E975663234A\", \"3\")")	);
	...
	__Local__18->LayoutData.Offsets.Left = 1185.000000f;
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"F233FCDF4043378F8CE06ABADEDD6EAB\", \"4\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"A3E381F743195ADCB84CE48D36AD807C\", \"5\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"2E14EFC547123959784BD3B0C793855A\", \"[X-axis Title]\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"1D355C7B42D1ABF7055F6D907D172FF0\", \"Total Time Suttering\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"AA3B1AA244BACE7804AB169392837593\", \"00:00\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"6A5465614B7B933979D6BBBEFCA4A045\", \"00:00\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"2FC2ABD04BB62F7E353086966D931E54\", \"00:00\")")	);
	...
	__Local__43 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTime_Stuttering_Graph_C__pf517162645::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__46 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTime_Stuttering_Graph_C__pf517162645::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__49 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTime_Stuttering_Graph_C__pf517162645::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__52 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTime_Stuttering_Graph_C__pf517162645::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__55 = CastChecked<UObject>(CastChecked<UDynamicClass>(UTime_Stuttering_Graph_C__pf517162645::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"AF704CD440572FD627AAFBB79FE16119\", \"8\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"FE1E6B994BA51398D6A62DA9E8617EB3\", \"10\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"42D002934EAEBEDE9AE3CA8B85C68DA9\", \"10\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"8691072D470955A5CA5AA8B5078C4B3E\", \"10\")")	);
...
TEXT("NSLOCTEXT(\"[2C44984E4643D1092AEA5A94F21AC859]\", \"FDB996164B79963B988DA2A112642694\", \"10\")")	);
...
PRAGMA_ENABLE_OPTIMIZATION
void UTime_Stuttering_Graph_C__pf517162645::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__79;
	SlotNames.Append(__Local__79);
}
void UTime_Stuttering_Graph_C__pf517162645::InitializeNativeClassData()
{
	...
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UTime_Stuttering_Graph_C__pf517162645::StaticClass())->MiscConvertedSubobjects[0]), __Local__80, __Local__81);
}
void UTime_Stuttering_Graph_C__pf517162645::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UTime_Stuttering_Graph_C__pf517162645::bpf__ExecuteUbergraph_Time_Stuttering_Graph__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 51:
			{
				bpv__YxaxisxTitle__pfGT = FString(TEXT("Total Time Stuttering"));
			}
		case 52:
			{
...
void UTime_Stuttering_Graph_C__pf517162645::bpf__CreateGraphBySwitcher__pf()
{
	bpf__ExecuteUbergraph_Time_Stuttering_Graph__pf_0(48);
}
void UTime_Stuttering_Graph_C__pf517162645::bpf__ResetxGraph__pfT()
{
...
void UTime_Stuttering_Graph_C__pf517162645::bpf__SetxYxaxis__pfTG()
{
...
void UTime_Stuttering_Graph_C__pf517162645::bpf__GetxData__pfT()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bool bpfv__CallFunc_Less_IntInt_ReturnValue__pf{};
	UGameInstance* bpfv__CallFunc_GetGameInstance_ReturnValue__pf{};
		...
		case 5:
			{
				...
				bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(bpv__DataxBeingxUsed__pfTT, bpfv__CallFunc_Array_Get_Item__pf.bpv__TotalTimeStuttering_21_1FB96301419BBBED9E6C82AB8C5756CD__pf);
			}
		case 6:
			{
...
void UTime_Stuttering_Graph_C__pf517162645::bpf__SetxDotxPosition__pfTT(/*out*/ UImage*& bpp__Dot__pf, int32 bpp__DotxNumber__pfT, float bpp__DataxNumber__pfT, UTextBlock* bpp__Label__pf, bool bpp__DotxReset__pfT)
{
...
void UTime_Stuttering_Graph_C__pf517162645::bpf__PlacexLine__pfT(UImage* bpp__ReferencexxxDotx1__pfTGTT, UImage* bpp__ReferencexxxDotx2__pfTGTT, /*out*/ UImage*& bpp__LinextoxSet__pfTT, /*out*/ bool& bpp__Resetx__pfzy)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void UTime_Stuttering_Graph_C__pf517162645::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UTime_Stuttering_Graph_C__pf517162645::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UTime_Stuttering_Graph_C__pf517162645
{
	FRegisterHelper__UTime_Stuttering_Graph_C__pf517162645()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Widgets/Graphing_Widgets/Time_Stuttering_Graph"), &UTime_Stuttering_Graph_C__pf517162645::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UTime_Stuttering_Graph_C__pf517162645 Instance;
};
FRegisterHelper__UTime_Stuttering_Graph_C__pf517162645 FRegisterHelper__UTime_Stuttering_Graph_C__pf517162645::Instance;
