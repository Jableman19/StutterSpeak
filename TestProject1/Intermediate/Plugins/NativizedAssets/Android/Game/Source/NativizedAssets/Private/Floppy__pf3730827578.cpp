...
#include "FloppyResetBox_Blueprint__pf3730827578.h"
...
AFloppy_C__pf3730827578::AFloppy_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__StaticMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("StaticMesh"));
	bpv__FloppyxName__pfT = CreateDefaultSubobject<UWidgetComponent>(TEXT("Floppy Name"));
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(5);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	...
	__Local__1 = FVector(0.100000, 0.050000, 0.050000);
	...
	bpv__FloppyxName__pfT->CreationMethod = EComponentCreationMethod::Native;
	bpv__FloppyxName__pfT->AttachToComponent(bpv__StaticMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__4 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__FloppyxName__pfT), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__4 = UFloppy_Text_C__pf2075166221::StaticClass();
	auto& __Local__5 = (*(AccessPrivateProperty<FIntPoint >((bpv__FloppyxName__pfT), UWidgetComponent::__PPO__DrawSize() )));
	__Local__5.X = 275;
	__Local__5.Y = 240;
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__FloppyxName__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__6 = FVector(3.126108, 2.060738, -30.597490);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__FloppyxName__pfT), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__7 = FVector(0.500000, 0.500000, 0.500000);
	(((FBoolProperty*)__Local__2)->SetPropertyValue_InContainer((bpv__FloppyxName__pfT), true, 0));
	bpv__SpawnxLocation__pfT = FVector(0.000000, 0.000000, 0.000000);
	bpv__SpawnxRotation__pfT = FRotator(0.000000, 0.000000, 0.000000);
	bpv__NotxBeingxUsed__pfTT = true;
	bpv__Grabbable__pf = true;
	bpv__Respawning__pf = false;
	...
	Tags = TArray<FName> ();
	Tags.Reserve(1);
	Tags.Add(FName(TEXT("floppy")));
}
PRAGMA_ENABLE_OPTIMIZATION
void AFloppy_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__FloppyxName__pfT)
	{
		bpv__FloppyxName__pfT->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AFloppy_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AFloppyResetBox_Blueprint_C__pf3730827578::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void AFloppy_C__pf3730827578::bpf__ExecuteUbergraph_Floppy__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				...
				bpv__SpawnxLocation__pfT = bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf;
			}
		case 3:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpv__StaticMesh__pf->USceneComponent::K2_GetComponentRotation();
				}
				bpv__SpawnxRotation__pfT = bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf;
				__CurrentState = -1;
				break;
			}
		case 40:
		...
		case 41:
			{
				FCustomThunkTemplates::Array_Get(Tags, 1, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				bpfv__CallFunc_EqualEqual_NameName_ReturnValue__pf = UKismetMathLibrary::EqualEqual_NameName(b0l__CallFunc_Array_Get_Item_1__pf, FName(TEXT("Hologram")));
...
void AFloppy_C__pf3730827578::bpf__ExecuteUbergraph_Floppy__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_GetDisplayName_ReturnValue__pf = UKismetSystemLibrary::GetDisplayName(b0l__K2Node_Event_OtherActor__pf);
	bpfv__CallFunc_EqualEqual_StrStr_ReturnValue__pf = UKismetStringLibrary::EqualEqual_StrStr(bpfv__CallFunc_GetDisplayName_ReturnValue__pf, FString(TEXT("FloppyResetBox_Blueprint")));
	bpfv__CallFunc_BooleanAND_ReturnValue__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_EqualEqual_StrStr_ReturnValue__pf, bpv__NotxBeingxUsed__pfTT);
	bpfv__CallFunc_Not_PreBool_ReturnValue_1__pf = UKismetMathLibrary::Not_PreBool(bpv__Respawning__pf);
	bpfv__CallFunc_BooleanAND_ReturnValue_1__pf = UKismetMathLibrary::BooleanAND(bpfv__CallFunc_BooleanAND_ReturnValue__pf, bpfv__CallFunc_Not_PreBool_ReturnValue_1__pf);
	if (!bpfv__CallFunc_BooleanAND_ReturnValue_1__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	bpv__Respawning__pf = true;
	bpv__Grabbable__pf = false;
	bpf__RespawnBySelf__pf();
	return; //KCST_EndOfThread
}
void AFloppy_C__pf3730827578::bpf__ExecuteUbergraph_Floppy__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 8:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->SetPhysicsLinearVelocity(FVector(0.000000,0.000000,0.000000), false, FName(TEXT("None")));
				}
			}
		case 9:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpv__StaticMesh__pf->SetPhysicsAngularVelocityInRadians(FVector(0.000000,0.000000,0.000000), false, FName(TEXT("None")));
				}
			}
		case 10:
			{
				bpfv__CallFunc_K2_SetActorLocationAndRotation_ReturnValue__pf = AActor::K2_SetActorLocationAndRotation(bpv__SpawnxLocation__pfT, bpv__SpawnxRotation__pfT, false, /*out*/ b0l__CallFunc_K2_SetActorLocationAndRotation_SweepHitResult__pf, false);
			}
		case 11:
			{
				bpv__Respawning__pf = false;
		...
		case 39:
			{
				UKismetSystemLibrary::Delay(this, 1.000000, FLatentActionInfo(7, 1124793378, TEXT("ExecuteUbergraph_Floppy_2"), this));
				__CurrentState = -1;
				break;
			}
		case 42:
...
void AFloppy_C__pf3730827578::bpf__ExecuteUbergraph_Floppy__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 14:
			{
				if(::IsValid(bpv__StaticMesh__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf = bpv__StaticMesh__pf->USceneComponent::K2_GetComponentLocation();
				}
				UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf, FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), ((AActor*)nullptr));
			}
		case 15:
			{
				(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(this, AFloppyResetBox_Blueprint_C__pf3730827578::StaticClass(), /*out*/ TArrayCaster<AFloppyResetBox_Blueprint_C__pf3730827578*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 16:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_AsFloppy_Reset_Box_Blueprint__pf = Cast<AFloppyResetBox_Blueprint_C__pf3730827578>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsFloppy_Reset_Box_Blueprint__pf != nullptr);;
		...
		case 17:
			{
				bpfv__CallFunc_IsOverlappingActor_ReturnValue__pf = AActor::IsOverlappingActor(b0l__K2Node_DynamicCast_AsFloppy_Reset_Box_Blueprint__pf);
		...
		case 18:
			{
				bpfv__CallFunc_Not_PreBool_ReturnValue__pf = UKismetMathLibrary::Not_PreBool(bpv__Respawning__pf);
...
void AFloppy_C__pf3730827578::bpf__ExecuteUbergraph_Floppy__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	bpv__NotxBeingxUsed__pfTT = false;
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__StaticMesh__pf))
	{
	...
	{
		bpfv__CallFunc_K2_AttachToComponent_ReturnValue__pf = bpfv__CallFunc_K2_GetRootComponent_ReturnValue__pf->USceneComponent::K2_AttachToComponent(b0l__K2Node_Event_AttachTo__pf, FName(TEXT("None")), EAttachmentRule::SnapToTarget, EAttachmentRule::SnapToTarget, EAttachmentRule::KeepWorld, false);
	}
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = bpv__StaticMesh__pf->USceneComponent::K2_GetComponentLocation();
	}
	UGameplayStatics::PlaySoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AFloppy_C__pf3730827578::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf, FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), ((AActor*)nullptr));
	if(::IsValid(bpv__StaticMesh__pf))
	{
		bpv__StaticMesh__pf->USceneComponent::K2_SetRelativeLocationAndRotation(FVector(2.000000,0.000000,-3.000000), FRotator(90.000000,300.000000,120.000000), false, /*out*/ b0l__CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult__pf, true);
	}
	return; //KCST_EndOfThread
}
void AFloppy_C__pf3730827578::bpf__ExecuteUbergraph_Floppy__pf_5(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 33:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(4, -533476630, TEXT("ExecuteUbergraph_Floppy_5"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AFloppy_C__pf3730827578::bpf__RespawnBySelf__pf()
{
	bpf__ExecuteUbergraph_Floppy__pf_2(42);
}
void AFloppy_C__pf3730827578::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Floppy__pf_0(40);
}
void AFloppy_C__pf3730827578::bpf__ReceiveActorEndOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Floppy__pf_1(34);
}
void AFloppy_C__pf3730827578::bpf__EnablePhysicsByProjector__pf()
{
	bpf__ExecuteUbergraph_Floppy__pf_5(32);
}
void AFloppy_C__pf3730827578::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_Floppy__pf_4(29);
}
void AFloppy_C__pf3730827578::bpf__Drop__pf()
{
	bpf__ExecuteUbergraph_Floppy__pf_3(27);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFloppy_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AFloppy_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{152, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Blueprints/FloppyResetBox_Blueprint.FloppyResetBox_Blueprint_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AFloppy_C__pf3730827578
{
	FRegisterHelper__AFloppy_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Floppy"), &AFloppy_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AFloppy_C__pf3730827578 Instance;
};
FRegisterHelper__AFloppy_C__pf3730827578 FRegisterHelper__AFloppy_C__pf3730827578::Instance;
