...
USpeechPageW_C__pf1694860710::USpeechPageW_C__pf1694860710(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Image_0__pf = nullptr;
	bpv__PageNumber__pf = nullptr;
	bpv__TextBody__pf = nullptr;
	bpv__PageNum__pf = 0;
	bpv__PageShown__pf = 1;
	bpv__Size__pf = 24;
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USpeechPageW_C__pf1694860710::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USpeechPageW_C__pf1694860710::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_7"), (EObjectFlags)0x00280008);
	__Local__3->LayoutData.Offsets.Left = 528.000000f;
	__Local__3->LayoutData.Offsets.Top = 20.000000f;
	__Local__3->LayoutData.Offsets.Right = 807.500000f;
	__Local__3->LayoutData.Offsets.Bottom = 1045.000000f;
	__Local__3->Parent = __Local__1;
	auto __Local__4 = NewObject<UImage>(__Local__0, TEXT("Image_0"), (EObjectFlags)0x00280008);
	...
	__Local__5->LayoutData.Offsets.Left = 548.000000f;
	__Local__5->LayoutData.Offsets.Top = 40.000000f;
	__Local__5->LayoutData.Offsets.Right = 754.124939f;
	__Local__5->LayoutData.Offsets.Bottom = 963.306641f;
	__Local__5->Parent = __Local__1;
	auto __Local__6 = NewObject<UTextBlock>(__Local__0, TEXT("TextBody"), (EObjectFlags)0x00280008);
	__Local__6->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"UMG\", \"TextBlockDefaultValue\", \"Text Block\")")	);
	auto& __Local__7 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__6->ColorAndOpacity), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__7 = FLinearColor(0.000000, 0.000000, 0.000000, 1.000000);
	static TWeakFieldPtr<FProperty> __Local__9{};
	const FProperty* __Local__8 = __Local__9.Get();
	if (nullptr == __Local__8)
	{
		__Local__8 = (UTextLayoutWidget::StaticClass())->FindPropertyByName(FName(TEXT("AutoWrapText")));
		check(__Local__8);
		__Local__9 = __Local__8;
	}
	(((FBoolProperty*)__Local__8)->SetPropertyValue_InContainer((__Local__6), true, 0));
	__Local__6->Slot = __Local__5;
	__Local__6->bIsVariable = true;
	__Local__5->Content = __Local__6;
	__Local__2.Add(__Local__5);
	auto __Local__10 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__10->LayoutData.Offsets.Left = 1292.000000f;
	__Local__10->LayoutData.Offsets.Top = 1020.000000f;
	__Local__10->LayoutData.Offsets.Right = 39.692780f;
	__Local__10->LayoutData.Offsets.Bottom = 43.841003f;
	__Local__10->Parent = __Local__1;
	auto __Local__11 = NewObject<UTextBlock>(__Local__0, TEXT("PageNumber"), (EObjectFlags)0x00280008);
	__Local__11->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5DBA5562459F09F628E7A9B0BD2F2E84]\", \"172CBA2946E3D82EDE2F79B27C5ADAF7\", \"1\")")	);
...
PRAGMA_ENABLE_OPTIMIZATION
void USpeechPageW_C__pf1694860710::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__13;
	SlotNames.Append(__Local__13);
}
void USpeechPageW_C__pf1694860710::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__14;
	TArray<FDelegateRuntimeBinding>  __Local__15;
	__Local__15.AddUninitialized(2);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__15.GetData(), 2);
	auto& __Local__16 = __Local__15[0];
	__Local__16.ObjectName = FString(TEXT("TextBody"));
	__Local__16.PropertyName = FName(TEXT("Text"));
	__Local__16.FunctionName = FName(TEXT("GetText_0"));
	auto& __Local__17 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__16.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__17 = TArray<FPropertyPathSegment> ();
	__Local__17.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__17.GetData(), 1);
	auto& __Local__18 = __Local__17[0];
	__Local__18.Name = FName(TEXT("GetText_0"));
	auto& __Local__19 = __Local__15[1];
	__Local__19.ObjectName = FString(TEXT("PageNumber"));
	...
	__Local__21.Name = FName(TEXT("PageShown"));
	__Local__19.Kind = EBindingKind::Property;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(USpeechPageW_C__pf1694860710::StaticClass())->MiscConvertedSubobjects[0]), __Local__14, __Local__15);
}
void USpeechPageW_C__pf1694860710::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void USpeechPageW_C__pf1694860710::bpf__ExecuteUbergraph_SpeechPageW__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_Subtract_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Subtract_IntInt(bpv__PageNum__pf, 1);
	TArray<FString>  __Local__22 = {};
	FCustomThunkTemplates::Array_Get(((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__PagesArray__pf) : (__Local__22)), bpfv__CallFunc_Subtract_IntInt_ReturnValue_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
	bpfv__CallFunc_NotEqual_StrStr_ReturnValue__pf = UKismetStringLibrary::NotEqual_StrStr(b0l__CallFunc_Array_Get_Item__pf, FString(TEXT("")));
	if (!bpfv__CallFunc_NotEqual_StrStr_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__PageNum__pf, 1);
	b0l__Temp_int_Variable_2__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
	bpv__PageNum__pf = b0l__Temp_int_Variable_2__pf;
	bpfv__CallFunc_Subtract_IntInt_ReturnValue_2__pf = UKismetMathLibrary::Subtract_IntInt(bpv__PageShown__pf, 1);
	b0l__Temp_int_Variable__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue_2__pf;
	bpv__PageShown__pf = b0l__Temp_int_Variable__pf;
	return; // KCST_GotoReturn
}
void USpeechPageW_C__pf1694860710::bpf__ExecuteUbergraph_SpeechPageW__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 15:
			{
				...
				b0l__K2Node_DynamicCast_AsMenu_GI_2__pf = Cast<UMenuGI_C__pf3730827578>(bpfv__CallFunc_GetGameInstance_ReturnValue_2__pf);
		...
		case 16:
			{
				...
				bpfv__CallFunc_EqualEqual_StrStr_ReturnValue_1__pf = UKismetStringLibrary::EqualEqual_StrStr(((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI_2__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI_2__pf->bpv__TextSize__pf) : (__Local__23)), FString(TEXT("Small")));
		...
		case 18:
			{
				UObject*  __Local__24 = ((UObject*)nullptr);
				static TWeakFieldPtr<FProperty> __Local__26{};
				const FProperty* __Local__25 = __Local__26.Get();
				if (nullptr == __Local__25)
				{
					__Local__25 = (FSlateFontInfo::StaticStruct())->FindPropertyByName(FName(TEXT("FontObject")));
					check(__Local__25);
					__Local__26 = __Local__25;
				}
				(*(__Local__25->ContainerPtrToValuePtr<UObject* >(&(b0l__K2Node_MakeStruct_SlateFontInfo__pf), 0))) = ((::IsValid(bpv__TextBody__pf)) ? (const_cast<UObject*>(bpv__TextBody__pf->Font.FontObject)) : (__Local__24));
				UObject*  __Local__27 = ((UObject*)nullptr);
				b0l__K2Node_MakeStruct_SlateFontInfo__pf.FontMaterial = ((::IsValid(bpv__TextBody__pf)) ? (bpv__TextBody__pf->Font.FontMaterial) : (__Local__27));
				auto __Local__29 = FFontOutlineSettings{};
				FFontOutlineSettings  __Local__28 = __Local__29;
				b0l__K2Node_MakeStruct_SlateFontInfo__pf.OutlineSettings = ((::IsValid(bpv__TextBody__pf)) ? (bpv__TextBody__pf->Font.OutlineSettings) : (__Local__28));
				FName  __Local__30 = FName();
				b0l__K2Node_MakeStruct_SlateFontInfo__pf.TypefaceFontName = ((::IsValid(bpv__TextBody__pf)) ? (bpv__TextBody__pf->Font.TypefaceFontName) : (__Local__30));
				b0l__K2Node_MakeStruct_SlateFontInfo__pf.Size = bpv__Size__pf;
				int32  __Local__31 = 0;
				b0l__K2Node_MakeStruct_SlateFontInfo__pf.LetterSpacing = ((::IsValid(bpv__TextBody__pf)) ? (bpv__TextBody__pf->Font.LetterSpacing) : (__Local__31));
				if(::IsValid(bpv__TextBody__pf))
				{
					bpv__TextBody__pf->UTextBlock::SetFont(b0l__K2Node_MakeStruct_SlateFontInfo__pf);
				}
				__CurrentState = -1;
				break;
			}
		case 19:
			{
				FString  __Local__32 = FString(TEXT(""));
				bpfv__CallFunc_EqualEqual_StrStr_ReturnValue__pf = UKismetStringLibrary::EqualEqual_StrStr(((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI_2__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI_2__pf->bpv__TextSize__pf) : (__Local__32)), FString(TEXT("Medium")));
...
void USpeechPageW_C__pf1694860710::bpf__ExecuteUbergraph_SpeechPageW__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Add_IntInt(bpv__PageNum__pf, 1);
	TArray<FString>  __Local__33 = {};
	FCustomThunkTemplates::Array_Get(((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI_1__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI_1__pf->bpv__PagesArray__pf) : (__Local__33)), bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
	bpfv__CallFunc_NotEqual_StrStr_ReturnValue_1__pf = UKismetStringLibrary::NotEqual_StrStr(b0l__CallFunc_Array_Get_Item_1__pf, FString(TEXT("")));
	if (!bpfv__CallFunc_NotEqual_StrStr_ReturnValue_1__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__PageNum__pf, 1);
	b0l__Temp_int_Variable_1__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	bpv__PageNum__pf = b0l__Temp_int_Variable_1__pf;
	bpfv__CallFunc_Add_IntInt_ReturnValue_2__pf = UKismetMathLibrary::Add_IntInt(bpv__PageShown__pf, 1);
	b0l__Temp_int_Variable_3__pf = bpfv__CallFunc_Add_IntInt_ReturnValue_2__pf;
	bpv__PageShown__pf = b0l__Temp_int_Variable_3__pf;
	return; // KCST_GotoReturn
}
void USpeechPageW_C__pf1694860710::bpf__NextPageByNextButton__pf()
{
	bpf__ExecuteUbergraph_SpeechPageW__pf_2(1);
}
void USpeechPageW_C__pf1694860710::bpf__PreviousPageByBackButton__pf()
{
	bpf__ExecuteUbergraph_SpeechPageW__pf_0(22);
}
void USpeechPageW_C__pf1694860710::bpf__OnInitialized__pf()
{
	bpf__ExecuteUbergraph_SpeechPageW__pf_1(14);
}
FText  USpeechPageW_C__pf1694860710::bpf__GetText_0__pf()
{
	...
	do
	{
		...
		case 2:
			{
				TArray<FString>  __Local__34 = {};
				FCustomThunkTemplates::Array_Get(((::IsValid(bpfv__K2Node_DynamicCast_AsMenu_GI__pf)) ? (bpfv__K2Node_DynamicCast_AsMenu_GI__pf->bpv__PagesArray__pf) : (__Local__34)), bpv__PageNum__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
...
PRAGMA_DISABLE_OPTIMIZATION
void USpeechPageW_C__pf1694860710::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USpeechPageW_C__pf1694860710::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{68, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/SlateCore.SlateFontInfo 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USpeechPageW_C__pf1694860710
{
	FRegisterHelper__USpeechPageW_C__pf1694860710()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Widgets/Speech_World/SpeechPageW"), &USpeechPageW_C__pf1694860710::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USpeechPageW_C__pf1694860710 Instance;
};
FRegisterHelper__USpeechPageW_C__pf1694860710 FRegisterHelper__USpeechPageW_C__pf1694860710::Instance;
