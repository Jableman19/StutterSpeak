...
#include "Page_Change_Button__pf3730827578.h"
...
APage_Change_Button_C__pf3730827578::APage_Change_Button_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Arrow__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APage_Change_Button_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Arrow__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Arrow__pf->OverrideMaterials.Reserve(1);
	bpv__Arrow__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(APage_Change_Button_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Arrow__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__3 = FVector(0.090000, 0.090000, 0.075000);
	...
	bpv__TextRender__pf->AttachToComponent(bpv__Arrow__pf, FAttachmentTransformRules::KeepRelativeTransform );
	...
	bpv__TextRender__pf->WorldSize = 131.412186f;
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(3.873086, -81.554161, 41.906452);
	auto& __Local__5 = (*(AccessPrivateProperty<FRotator >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__5 = FRotator(90.000000, 0.000000, 0.000000);
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(1.000000, 0.700000, 1.050000);
	...
	bpv__Sound__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(APage_Change_Button_C__pf3730827578::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__Sound__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Sound__pf), false, 0));
	bpv__Previous__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[14DA475348A697037948EEACEC367BE1]\", \"3B81BCB54E8C9A7107C05DA8026DDEEB\", \"Previous\")")	);
	bpv__Next__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[14DA475348A697037948EEACEC367BE1]\", \"DD74FD764D077205E269368F9EAFB669\", \"Next\")")	);
...
void APage_Change_Button_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APage_Change_Button_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto& __Local__9 = __Local__8->ComponentDelegateBindings[0];
	__Local__9.ComponentPropertyName = FName(TEXT("Arrow"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__Page_Change_Button_Arrow_K2Node_ComponentBoundEvent_4_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APage_Change_Button_C__pf3730827578::bpf__ExecuteUbergraph_Page_Change_Button__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(2, -29618682, TEXT("ExecuteUbergraph_Page_Change_Button_0"), this));
				__CurrentState = -1;
				break;
			}
		case 2:
		...
		case 4:
			{
				bpfv__CallFunc_MakeTransform_ReturnValue_1__pf = UKismetMathLibrary::MakeTransform(bpv__UpxLocation__pfT, bpv__ReturnxValuexRotation__pfTT, bpv__ReturnxValuexScale__pfTT);
				if(::IsValid(bpv__Arrow__pf))
				{
					bpv__Arrow__pf->USceneComponent::K2_SetRelativeTransform(bpfv__CallFunc_MakeTransform_ReturnValue_1__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeTransform_SweepHitResult_1__pf, false);
				}
			}
		case 5:
			{
		...
		case 13:
			{
				...
				bpfv__CallFunc_EqualEqual_NameName_ReturnValue_1__pf = UKismetMathLibrary::EqualEqual_NameName(b0l__CallFunc_Array_Get_Item_2__pf, FName(TEXT("Next")));
		...
		case 14:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf))
				{
					b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf->bpf__NextPageByNextButton__pf();
				}
				__CurrentState = 1;
				break;
			}
		case 15:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf))
				{
					b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf->bpf__PreviousPageByBackButton__pf();
				}
				__CurrentState = 1;
				break;
			}
		...
		case 18:
			{
				if(::IsValid(bpv__Arrow__pf))
				{
					bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf = bpv__Arrow__pf->USceneComponent::GetRelativeTransform();
				}
		...
		case 21:
			{
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(bpv__UpxLocation__pfT, FVector(0.000000,0.000000,2.000000));
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf, bpv__ReturnxValuexRotation__pfTT, bpv__ReturnxValuexScale__pfTT);
				if(::IsValid(bpv__Arrow__pf))
				{
					bpv__Arrow__pf->USceneComponent::K2_SetRelativeTransform(bpfv__CallFunc_MakeTransform_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeTransform_SweepHitResult__pf, false);
				}
			}
		case 22:
			{
...
void APage_Change_Button_C__pf3730827578::bpf__ExecuteUbergraph_Page_Change_Button__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				...
				{
					bpv__TextRender__pf->UTextRenderComponent::K2_SetText(bpv__Next__pf);
				}
			}
		case 7:
			{
				FVector  __Local__11 = FVector(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakVector(((::IsValid(bpv__TextRender__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__11)), /*out*/ b0l__CallFunc_BreakVector_X_2__pf, /*out*/ b0l__CallFunc_BreakVector_Y_2__pf, /*out*/ b0l__CallFunc_BreakVector_Z_2__pf);
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(0.000000, b0l__CallFunc_BreakVector_Y_2__pf, b0l__CallFunc_BreakVector_Z_2__pf);
				if(::IsValid(bpv__TextRender__pf))
				{
					bpv__TextRender__pf->USceneComponent::K2_SetRelativeLocation(bpfv__CallFunc_MakeVector_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeLocation_SweepHitResult__pf, false);
				}
				__CurrentState = -1;
				break;
			}
		case 8:
			{
				if(::IsValid(bpv__TextRender__pf))
				{
					bpv__TextRender__pf->UTextRenderComponent::K2_SetText(bpv__Previous__pf);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 27:
			{
				...
				bpfv__CallFunc_EqualEqual_NameName_ReturnValue__pf = UKismetMathLibrary::EqualEqual_NameName(b0l__CallFunc_Array_Get_Item_1__pf, FName(TEXT("Next")));
		...
		case 28:
			{
				FRotator  __Local__12 = FRotator(0.000000,0.000000,0.000000);
				UKismetMathLibrary::BreakRotator(((::IsValid(bpv__TextRender__pf)) ? ((*(AccessPrivateProperty<FRotator >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__12)), /*out*/ b0l__CallFunc_BreakRotator_Roll__pf, /*out*/ b0l__CallFunc_BreakRotator_Pitch__pf, /*out*/ b0l__CallFunc_BreakRotator_Yaw__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakRotator_Yaw__pf, 180.000000);
				...
				if(::IsValid(bpv__TextRender__pf))
				{
					bpv__TextRender__pf->USceneComponent::K2_SetRelativeRotation(bpfv__CallFunc_MakeRotator_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeRotation_SweepHitResult__pf, false);
				}
				__CurrentState = 6;
				break;
			}
...
void APage_Change_Button_C__pf3730827578::bpf__BndEvt__Page_Change_Button_Arrow_K2Node_ComponentBoundEvent_4_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Page_Change_Button__pf_0(29);
}
void APage_Change_Button_C__pf3730827578::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Page_Change_Button__pf_1(26);
}
PRAGMA_DISABLE_OPTIMIZATION
void APage_Change_Button_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{242, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/Stutter_Speak_Content/Pre-Fabs/CompleteModels/Arrow.Arrow 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APage_Change_Button_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APage_Change_Button_C__pf3730827578
{
	FRegisterHelper__APage_Change_Button_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Page_Change_Button"), &APage_Change_Button_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APage_Change_Button_C__pf3730827578 Instance;
};
FRegisterHelper__APage_Change_Button_C__pf3730827578 FRegisterHelper__APage_Change_Button_C__pf3730827578::Instance;
