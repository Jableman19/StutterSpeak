...
#include "Percentage_Stuttering_Graph__pf517162645.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Stutter_Speak_Content/Widgets/Graphing_Widgets/Percentage_Stuttering_Graph.Percentage_Stuttering_Graph_C", OverrideNativeName="Percentage_Stuttering_Graph_C"))
class UPercentage_Stuttering_Graph_C__pf517162645 : public UUserWidget
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_165", Category="Percentage_Stuttering_Graph", OverrideNativeName="Image_165"))
	UImage* bpv__Image_165__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Line 1", Category="Percentage_Stuttering_Graph", OverrideNativeName="Line1"))
	UImage* bpv__Line1__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Line 2", Category="Percentage_Stuttering_Graph", OverrideNativeName="Line2"))
	UImage* bpv__Line2__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Line 3", Category="Percentage_Stuttering_Graph", OverrideNativeName="Line3"))
	UImage* bpv__Line3__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Line 4", Category="Percentage_Stuttering_Graph", OverrideNativeName="Line4"))
	UImage* bpv__Line4__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Number Label 1", Category="Percentage_Stuttering_Graph", OverrideNativeName="NumberLabel1"))
	UTextBlock* bpv__NumberLabel1__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Number Label 2", Category="Percentage_Stuttering_Graph", OverrideNativeName="NumberLabel2"))
	UTextBlock* bpv__NumberLabel2__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Number Label 3", Category="Percentage_Stuttering_Graph", OverrideNativeName="NumberLabel3"))
	UTextBlock* bpv__NumberLabel3__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Number Label 4", Category="Percentage_Stuttering_Graph", OverrideNativeName="NumberLabel4"))
	UTextBlock* bpv__NumberLabel4__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Number Label 5", Category="Percentage_Stuttering_Graph", OverrideNativeName="NumberLabel5"))
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="X-1 Dot", Category="Percentage_Stuttering_Graph", OverrideNativeName="X-1Dot"))
	UImage* bpv__Xx1Dot__pfG;
	UPROPERTY(Export, meta=(DisplayName="X-2", OverrideNativeName="X-2"))
	UTextBlock* bpv__Xx2__pfG;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="X-2 Dot", Category="Percentage_Stuttering_Graph", OverrideNativeName="X-2Dot"))
	UImage* bpv__Xx2Dot__pfG;
	UPROPERTY(Export, meta=(DisplayName="X-3", OverrideNativeName="X-3"))
	UTextBlock* bpv__Xx3__pfG;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="X-3 Dot", Category="Percentage_Stuttering_Graph", OverrideNativeName="X-3Dot"))
	UImage* bpv__Xx3Dot__pfG;
	UPROPERTY(Export, meta=(DisplayName="X-4", OverrideNativeName="X-4"))
	UTextBlock* bpv__Xx4__pfG;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="X-4 Dot", Category="Percentage_Stuttering_Graph", OverrideNativeName="X-4Dot"))
	UImage* bpv__Xx4Dot__pfG;
	UPROPERTY(Export, meta=(DisplayName="X-5", OverrideNativeName="X-5"))
	UTextBlock* bpv__Xx5__pfG;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="X-5 Dot", Category="Percentage_Stuttering_Graph", OverrideNativeName="X-5Dot"))
	UImage* bpv__Xx5Dot__pfG;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="X-axis", Category="Percentage_Stuttering_Graph", OverrideNativeName="X-axis"))
	...
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Y-axis", Category="Percentage_Stuttering_Graph", OverrideNativeName="Y-axis"))
	...
	UPercentage_Stuttering_Graph_C__pf517162645(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Percentage_Stuttering_Graph__pf_0(int32 bpp__EntryPoint__pf);
	...
	virtual void bpf__SetxDotxPosition__pfTT(/*out*/ UImage*& bpp__Dot__pf, int32 bpp__DotxNumber__pfT, int32 bpp__DataxNumber__pfT, UTextBlock* bpp__Label__pf, bool bpp__DotxReset__pfT);
