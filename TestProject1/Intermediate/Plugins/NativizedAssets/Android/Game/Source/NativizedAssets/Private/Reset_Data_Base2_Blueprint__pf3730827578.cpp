...
AReset_Data_Base2_Blueprint_C__pf3730827578::AReset_Data_Base2_Blueprint_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AReset_Data_Base2_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__0->OverrideMaterials = TArray<UMaterialInterface*> ();
		__Local__0->OverrideMaterials.Reserve(2);
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AReset_Data_Base2_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AReset_Data_Base2_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		auto& __Local__2 = (*(AccessPrivateProperty<FVector >((__Local__0), USceneComponent::__PPO__RelativeScale3D() )));
		__Local__2 = FVector(0.634756, 0.634756, 0.634756);
	...
	bpv__ResetxWarning__pfT = CreateDefaultSubobject<UTextRenderComponent>(TEXT("Reset Warning"));
	...
	auto& __Local__5 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__Widget__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__5 = UReset_Button_Display_C__pf4267528607::StaticClass();
	auto& __Local__6 = (*(AccessPrivateProperty<FIntPoint >((bpv__Widget__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__6.X = 600;
	__Local__6.Y = 175;
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(18.560984, -0.000003, -6.220409);
	auto& __Local__8 = (*(AccessPrivateProperty<FRotator >((bpv__Widget__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__8 = FRotator(45.000000, 0.000000, 0.000000);
	auto& __Local__9 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__9 = FVector(1.000000, 0.027500, 0.025000);
	...
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((bpv__Widget__pf), true, 0));
	bpv__ResetxWarning__pfT->CreationMethod = EComponentCreationMethod::Native;
	bpv__ResetxWarning__pfT->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__ResetxWarning__pfT->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[F0A06A5946EF64DFB0996D8B1EFD6D28]\", \"A45181FE4C4A860B3194A79C05BDA215\", \"Reset Data for\")")	);
	bpv__ResetxWarning__pfT->HorizontalAlignment = EHorizTextAligment::EHTA_Center;
	bpv__ResetxWarning__pfT->VerticalAlignment = EVerticalTextAligment::EVRTA_TextCenter;
	bpv__ResetxWarning__pfT->WorldSize = 3.000000f;
	auto& __Local__12 = (*(AccessPrivateProperty<FVector >((bpv__ResetxWarning__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__12 = FVector(12.877166, 0.000000, -3.728058);
	auto& __Local__13 = (*(AccessPrivateProperty<FRotator >((bpv__ResetxWarning__pfT), USceneComponent::__PPO__RelativeRotation() )));
	__Local__13 = FRotator(90.000000, 0.000000, 0.000000);
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((bpv__ResetxWarning__pfT), false, 0));
	auto& __Local__14 = (*(AccessPrivateProperty<UStaticMeshComponent*>((this), AStaticMeshActor::__PPO__StaticMeshComponent() )));
...
void AReset_Data_Base2_Blueprint_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__ResetxWarning__pfT)
	{
		bpv__ResetxWarning__pfT->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AReset_Data_Base2_Blueprint_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AReset_Data_Base2_Blueprint_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AReset_Data_Base2_Blueprint_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AReset_Data_Base2_Blueprint_C__pf3730827578
{
	FRegisterHelper__AReset_Data_Base2_Blueprint_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Reset_Data_Base2_Blueprint"), &AReset_Data_Base2_Blueprint_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AReset_Data_Base2_Blueprint_C__pf3730827578 Instance;
};
FRegisterHelper__AReset_Data_Base2_Blueprint_C__pf3730827578 FRegisterHelper__AReset_Data_Base2_Blueprint_C__pf3730827578::Instance;
