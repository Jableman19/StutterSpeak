...
#include "Confirm_Rating_Button__pf3041421614.h"
...
#include "Hanging_Projector_Screen_Blueprint__pf3730827578.h"
#include "Active_Choice_Ring__pf3041421614.h"
...
AConfirm_Rating_Button_C__pf3041421614::AConfirm_Rating_Button_C__pf3041421614(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__ConfirmxButton__pfT = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Confirm Button"));
	...
	bpv__ButtonxBase__pfT = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Button Base"));
	...
	bpv__ConfirmxButton__pfT->CreationMethod = EComponentCreationMethod::Native;
	bpv__ConfirmxButton__pfT->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__ConfirmxButton__pfT), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ConfirmxButton__pfT->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ConfirmxButton__pfT->OverrideMaterials.Reserve(1);
	bpv__ConfirmxButton__pfT->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__ConfirmxButton__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(-0.000003, 0.000000, 0.709819);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__ConfirmxButton__pfT), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(0.045000, 0.094000, 0.020000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ConfirmxButton__pfT), true, 0));
	bpv__TextRender__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__TextRender__pf->AttachToComponent(bpv__ConfirmxButton__pfT, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__TextRender__pf->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[41C8BEAE40FBEF313F4FE1B5C08D32E2]\", \"8F5124894BDC877AD27E3FB5F8A4AFAF\", \"Confirm\")")	);
	bpv__TextRender__pf->TextRenderColor = FColor(0, 0, 0, 255);
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__5 = FVector(-27.544788, -40.117706, 51.525749);
	auto& __Local__6 = (*(AccessPrivateProperty<FRotator >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__6 = FRotator(90.000000, 0.000000, -179.437714);
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__TextRender__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__7 = FVector(1.000000, 1.000000, 5.250000);
	...
	bpv__Sound__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Sound__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__Sound__pf->bAutoActivate = false;
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Sound__pf), false, 0));
	bpv__ButtonxBase__pfT->CreationMethod = EComponentCreationMethod::Native;
	bpv__ButtonxBase__pfT->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__8 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__ButtonxBase__pfT), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__8 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ButtonxBase__pfT->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ButtonxBase__pfT->OverrideMaterials.Reserve(1);
	bpv__ButtonxBase__pfT->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
	auto& __Local__9 = (*(AccessPrivateProperty<FVector >((bpv__ButtonxBase__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__9 = FVector(0.000000, 0.000000, -1.014346);
	auto& __Local__10 = (*(AccessPrivateProperty<FVector >((bpv__ButtonxBase__pfT), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__10 = FVector(0.060000, 0.120000, 0.017500);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ButtonxBase__pfT), true, 0));
	bpv__SelectedxRating__pfT = 0;
	bpv__Active__pf = false;
	bpv__isPressedDown__pf = false;
	bpv__FirstxTime__pfT = true;
	bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT = nullptr;
	bpv__UpxLocation__pfT = FVector(0.000000, 0.000000, 0.000000);
	bpv__ReturnxValuexRotation__pfTT = FRotator(0.000000, 0.000000, 0.000000);
	bpv__ReturnxValuexScale__pfTT = FVector(0.000000, 0.000000, 0.000000);
	auto& __Local__11 = (*(AccessPrivateProperty<EActorUpdateOverlapsMethod >((this), AActor::__PPO__DefaultUpdateOverlapsMethodDuringLevelStreaming() )));
	__Local__11 = EActorUpdateOverlapsMethod::OnlyUpdateMovable;
	Tags = TArray<FName> ();
	Tags.Reserve(1);
	Tags.Add(FName(TEXT("Confirm Button")));
}
PRAGMA_ENABLE_OPTIMIZATION
void AConfirm_Rating_Button_C__pf3041421614::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__ButtonxBase__pfT)
	{
		bpv__ButtonxBase__pfT->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AConfirm_Rating_Button_C__pf3041421614::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AHanging_Projector_Screen_Blueprint_C__pf3730827578::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(AActive_Choice_Ring_C__pf3041421614::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UResultsDataBP_C__pf1694860710::StaticClass());
	...
	auto& __Local__13 = __Local__12->ComponentDelegateBindings[0];
	__Local__13.ComponentPropertyName = FName(TEXT("Confirm Button"));
	__Local__13.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__13.FunctionNameToBind = FName(TEXT("BndEvt__Confirm_Rating_Button_Confirm Button_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AConfirm_Rating_Button_C__pf3041421614::bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 46:
			{
				if(::IsValid(bpv__ConfirmxButton__pfT))
				{
					bpv__ConfirmxButton__pfT->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
				}
				__CurrentState = -1;
				break;
			}
...
void AConfirm_Rating_Button_C__pf3041421614::bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(5, -101795398, TEXT("ExecuteUbergraph_Confirm_Rating_Button_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 5:
		...
		case 7:
			{
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpv__UpxLocation__pfT, bpv__ReturnxValuexRotation__pfTT, bpv__ReturnxValuexScale__pfTT);
				if(::IsValid(bpv__ConfirmxButton__pfT))
				{
					bpv__ConfirmxButton__pfT->USceneComponent::K2_SetRelativeTransform(bpfv__CallFunc_MakeTransform_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeTransform_SweepHitResult_1__pf, false);
				}
			}
		case 8:
			{
		...
		case 10:
			{
				bpv__FirstxTime__pfT = false;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 11:
			{
				if(::IsValid(bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT) && ::IsValid(bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT->bpv__ResultsxData__pfT))
				{
					bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT->bpv__ResultsxData__pfT->bpf__ResultsCallbyConfirmRatingButton__pf();
				}
			}
		case 12:
			{
				if(::IsValid(bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT))
				{
					bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT->bpf__DisplayResults__pf();
				}
			}
		case 13:
			{
				bpv__MovexButtons__pfT.Broadcast();
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 16:
			{
				if(::IsValid(bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT))
				{
					bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT->bpf__ChangeWidget__pf();
				}
			}
		case 17:
			{
				(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(this, AActive_Choice_Ring_C__pf3041421614::StaticClass(), /*out*/ TArrayCaster<AActive_Choice_Ring_C__pf3041421614*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Get<AActor*>());
			}
		case 18:
			{
				...
				b0l__K2Node_DynamicCast_AsActive_Choice_Ring__pf = Cast<AActive_Choice_Ring_C__pf3041421614>(b0l__CallFunc_Array_Get_Item_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsActive_Choice_Ring__pf != nullptr);;
		...
		case 19:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsActive_Choice_Ring__pf))
				{
					b0l__K2Node_DynamicCast_AsActive_Choice_Ring__pf->bpf__ResetLocationByConfirm__pf();
				}
				__CurrentState = 1;
				break;
			}
		...
		case 23:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpf__CallxSavingxData__pfTT();
				}
				__CurrentState = 4;
				break;
			}
		case 24:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, AHanging_Projector_Screen_Blueprint_C__pf3730827578::StaticClass(), /*out*/ TArrayCaster<AHanging_Projector_Screen_Blueprint_C__pf3730827578*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 25:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_AsHanging_Projector_Screen_Blueprint__pf = Cast<AHanging_Projector_Screen_Blueprint_C__pf3730827578>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsHanging_Projector_Screen_Blueprint__pf != nullptr);;
		...
		case 26:
			{
				bpv__AsxHangingxProjectorxScreenxBlueprint__pfTTTT = b0l__K2Node_DynamicCast_AsHanging_Projector_Screen_Blueprint__pf;
			}
		case 27:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsMenu_GI_1__pf != nullptr);;
		...
		case 29:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMenu_GI_1__pf->bpv__DataxtoxSavexxxMessagexSatisfacationxRating__pfTTT3TTT = bpv__SelectedxRating__pfT;
				}
				__CurrentState = 16;
				break;
			}
		case 30:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI_1__pf))
				{
					b0l__K2Node_DynamicCast_AsMenu_GI_1__pf->bpv__DataxtoxSavexxxFluencyxSatisfactionxRating__pfTTT3TTT = bpv__SelectedxRating__pfT;
				}
				__CurrentState = 22;
				break;
			}
		...
		case 36:
			{
				if(::IsValid(bpv__ConfirmxButton__pfT))
				{
					bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf = bpv__ConfirmxButton__pfT->USceneComponent::GetRelativeTransform();
				}
				...
				bpv__UpxLocation__pfT = b0l__CallFunc_BreakTransform_Location__pf;
			}
		case 37:
			{
				if(::IsValid(bpv__ConfirmxButton__pfT))
				...
				UKismetMathLibrary::BreakTransform(bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf, /*out*/ b0l__CallFunc_BreakTransform_Location__pf, /*out*/ b0l__CallFunc_BreakTransform_Rotation__pf, /*out*/ b0l__CallFunc_BreakTransform_Scale__pf);
				bpv__ReturnxValuexRotation__pfTT = b0l__CallFunc_BreakTransform_Rotation__pf;
			}
		case 38:
			{
				if(::IsValid(bpv__ConfirmxButton__pfT))
				...
				UKismetMathLibrary::BreakTransform(bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf, /*out*/ b0l__CallFunc_BreakTransform_Location__pf, /*out*/ b0l__CallFunc_BreakTransform_Rotation__pf, /*out*/ b0l__CallFunc_BreakTransform_Scale__pf);
				bpv__ReturnxValuexScale__pfTT = b0l__CallFunc_BreakTransform_Scale__pf;
			}
		case 39:
			{
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(bpv__UpxLocation__pfT, FVector(0.000000,0.000000,0.500000));
				bpfv__CallFunc_MakeTransform_ReturnValue_1__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf, bpv__ReturnxValuexRotation__pfTT, bpv__ReturnxValuexScale__pfTT);
				if(::IsValid(bpv__ConfirmxButton__pfT))
				{
					bpv__ConfirmxButton__pfT->USceneComponent::K2_SetRelativeTransform(bpfv__CallFunc_MakeTransform_ReturnValue_1__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeTransform_SweepHitResult__pf, false);
				}
			}
		case 40:
			{
		...
		case 42:
			{
				if(::IsValid(bpv__ConfirmxButton__pfT))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__ConfirmxButton__pfT->USceneComponent::K2_GetComponentLocation();
				}
		...
		case 45:
			{
				bpfv__CallFunc_NotEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::NotEqual_IntInt(bpv__SelectedxRating__pfT, 0);
...
void AConfirm_Rating_Button_C__pf3041421614::bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 49);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__ConfirmxButton__pfT))
	{
		bpv__ConfirmxButton__pfT->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AConfirm_Rating_Button_C__pf3041421614::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
	}
	return; //KCST_EndOfThread
}
void AConfirm_Rating_Button_C__pf3041421614::bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_3(int32 bpp__EntryPoint__pf)
{
		...
		case 21:
			{
				...
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue_1__pf = UKismetMathLibrary::Subtract_VectorVector(((::IsValid(bpv__DefaultSceneRoot__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__DefaultSceneRoot__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__15)), FVector(0.000000,0.000000,15.000000));
				FRotator  __Local__16 = FRotator(0.000000,0.000000,0.000000);
				UKismetSystemLibrary::MoveComponentTo(bpv__DefaultSceneRoot__pf, bpfv__CallFunc_Subtract_VectorVector_ReturnValue_1__pf, ((::IsValid(bpv__DefaultSceneRoot__pf)) ? ((*(AccessPrivateProperty<FRotator >((bpv__DefaultSceneRoot__pf), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__16)), false, false, 1.000000, false, b0l__Temp_byte_Variable__pf, FLatentActionInfo(14, 1722463453, TEXT("ExecuteUbergraph_Confirm_Rating_Button_3"), this));
				__CurrentState = -1;
				break;
			}
		case 31:
...
void AConfirm_Rating_Button_C__pf3041421614::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_0(50);
}
void AConfirm_Rating_Button_C__pf3041421614::bpf__Enable__pf()
{
	bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_2(49);
}
void AConfirm_Rating_Button_C__pf3041421614::bpf__Disable__pf()
{
	bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_0(48);
}
void AConfirm_Rating_Button_C__pf3041421614::bpf__BndEvt__Confirm_Rating_Button_ConfirmxButton_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature__pfT(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__18;
	T__Local__18& bpp__SweepResult__pf = *const_cast<T__Local__18 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_1(44);
}
void AConfirm_Rating_Button_C__pf3041421614::bpf__LowerButton__pf()
{
	bpf__ExecuteUbergraph_Confirm_Rating_Button__pf_3(31);
}
PRAGMA_DISABLE_OPTIMIZATION
void AConfirm_Rating_Button_C__pf3041421614::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{206, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Starter_Content/Geometry/Meshes/CubeMaterial.CubeMaterial 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AConfirm_Rating_Button_C__pf3041421614::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{205, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Stutter_Speak_Content/Materials/MenuBG.MenuBG 
		{208, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/Stutter_Speak_Content/Pre-Fabs/CompleteModels/Hanging_Projector_Screen.Hanging_Projector_Screen 
		...
		{213, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Blueprints/Hanging_Projector_Screen_Blueprint.Hanging_Projector_Screen_Blueprint_C 
		{214, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Blueprints/Rating_Buttons/Active_Choice_Ring.Active_Choice_Ring_C 
		{211, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/Speech_World/ResultsDataBP.ResultsDataBP_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AConfirm_Rating_Button_C__pf3041421614
{
	FRegisterHelper__AConfirm_Rating_Button_C__pf3041421614()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Rating_Buttons/Confirm_Rating_Button"), &AConfirm_Rating_Button_C__pf3041421614::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AConfirm_Rating_Button_C__pf3041421614 Instance;
};
FRegisterHelper__AConfirm_Rating_Button_C__pf3041421614 FRegisterHelper__AConfirm_Rating_Button_C__pf3041421614::Instance;
