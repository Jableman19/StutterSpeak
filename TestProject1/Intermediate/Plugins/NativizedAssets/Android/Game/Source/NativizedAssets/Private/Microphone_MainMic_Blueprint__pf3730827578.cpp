...
AMicrophone_MainMic_Blueprint_C__pf3730827578::AMicrophone_MainMic_Blueprint_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__2 = FVector(0.071846, 0.071846, 0.071846);
	...
	bpv__RingMesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("RingMesh"));
	bpv__RingMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__RingMesh__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__5 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__RingMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__5 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__RingMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__RingMesh__pf->OverrideMaterials.Reserve(1);
	bpv__RingMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
	...
	(((FBoolProperty*)__Local__6)->SetPropertyValue_InContainer((bpv__RingMesh__pf), true, 0));
...
void AMicrophone_MainMic_Blueprint_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__RingMesh__pf)
	{
		bpv__RingMesh__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AMicrophone_MainMic_Blueprint_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AMicrophone_MainMic_Blueprint_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AMicrophone_MainMic_Blueprint_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AMicrophone_MainMic_Blueprint_C__pf3730827578
{
	FRegisterHelper__AMicrophone_MainMic_Blueprint_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Microphone_MainMic_Blueprint"), &AMicrophone_MainMic_Blueprint_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AMicrophone_MainMic_Blueprint_C__pf3730827578 Instance;
};
FRegisterHelper__AMicrophone_MainMic_Blueprint_C__pf3730827578 FRegisterHelper__AMicrophone_MainMic_Blueprint_C__pf3730827578::Instance;
