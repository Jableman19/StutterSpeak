...
ABPSpeechWorld_C__pf2075166221::ABPSpeechWorld_C__pf2075166221(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__2 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__Widget__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__2 = USpeechPageW_C__pf1694860710::StaticClass();
	auto& __Local__3 = (*(AccessPrivateProperty<FIntPoint >((bpv__Widget__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__3.X = 1920;
	__Local__3.Y = 1080;
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__4 = FVector(-39.707153, 4.000000, 77.276001);
	auto& __Local__5 = (*(AccessPrivateProperty<FRotator >((bpv__Widget__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__5 = FRotator(40.000015, 0.000000, 0.000000);
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(0.100000, 0.100000, 0.100000);
...
void ABPSpeechWorld_C__pf2075166221::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABPSpeechWorld_C__pf2075166221::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABPSpeechWorld_C__pf2075166221::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABPSpeechWorld_C__pf2075166221::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABPSpeechWorld_C__pf2075166221
{
	FRegisterHelper__ABPSpeechWorld_C__pf2075166221()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Widgets/BPSpeechWorld"), &ABPSpeechWorld_C__pf2075166221::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABPSpeechWorld_C__pf2075166221 Instance;
};
FRegisterHelper__ABPSpeechWorld_C__pf2075166221 FRegisterHelper__ABPSpeechWorld_C__pf2075166221::Instance;
