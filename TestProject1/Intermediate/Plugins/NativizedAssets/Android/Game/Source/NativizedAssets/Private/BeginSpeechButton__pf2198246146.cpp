...
#include "BeginSpeechButton__pf2198246146.h"
...
#include "TriggerBoxMainWorld__pf2552470103.h"
...
ABeginSpeechButton_C__pf2198246146::ABeginSpeechButton_C__pf2198246146(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABeginSpeechButton_C__pf2198246146::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__0->OverrideMaterials = TArray<UMaterialInterface*> ();
		__Local__0->OverrideMaterials.Reserve(1);
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABeginSpeechButton_C__pf2198246146::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__HitboxButton__pf = CreateDefaultSubobject<UCapsuleComponent>(TEXT("HitboxButton"));
	...
	__Local__5 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABeginSpeechButton_C__pf2198246146::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ButtonxTop__pfT->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ButtonxTop__pfT->OverrideMaterials.Reserve(1);
	bpv__ButtonxTop__pfT->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABeginSpeechButton_C__pf2198246146::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
...
TEXT("NSLOCTEXT(\"[D66BE4DA4A4FD153A000ECBD1DCDB983]\", \"76BCDDDD447F52CC2C1466A31B83C746\", \"Start Speech\")")	);
	...
	__Local__12 = FVector(49.160858, 0.251124, 283.368439);
	auto& __Local__13 = (*(AccessPrivateProperty<FRotator >((bpv__DisplayxText__pfT), USceneComponent::__PPO__RelativeRotation() )));
	__Local__13 = FRotator(50.000000, 180.000000, 0.000000);
	auto& __Local__14 = (*(AccessPrivateProperty<FVector >((bpv__DisplayxText__pfT), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__14 = FVector(2.000000, 1.530694, 5.000000);
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((bpv__DisplayxText__pfT), false, 0));
	bpv__HitboxButton__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__HitboxButton__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__HitboxButton__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__15 = (*(AccessPrivateProperty<FVector >((bpv__HitboxButton__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__15 = FVector(0.000000, -0.000002, 10.000000);
	auto& __Local__16 = (*(AccessPrivateProperty<FRotator >((bpv__HitboxButton__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__16 = FRotator(0.000000, 0.000000, -90.000000);
	auto& __Local__17 = (*(AccessPrivateProperty<FVector >((bpv__HitboxButton__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__17 = FVector(4.000000, 0.000000, 4.000000);
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((bpv__HitboxButton__pf), true, 0));
	...
	bpv__initializing__pf = false;
	bpv__UpLocation__pf = FVector(0.000000, 0.000000, 0.000000);
	bpv__DownLocation__pf = FVector(0.000000, 0.000000, 0.000000);
	auto& __Local__18 = (*(AccessPrivateProperty<UStaticMeshComponent*>((this), AStaticMeshActor::__PPO__StaticMeshComponent() )));
...
void ABeginSpeechButton_C__pf2198246146::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABeginSpeechButton_C__pf2198246146::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AStopSpeechButton_C__pf2198246146::StaticClass());
	...
	InDynamicClass->ReferencedConvertedFields.Add(ATriggerBoxMainWorld_C__pf2552470103::StaticClass());
	...
	(((FBoolProperty*)__Local__22)->SetPropertyValue_InContainer((__Local__20), false, 0));
	__Local__21->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__21->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__21->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__24 = __Local__21->ComponentDelegateBindings[0];
	__Local__24.ComponentPropertyName = FName(TEXT("HitboxButton"));
	__Local__24.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__24.FunctionNameToBind = FName(TEXT("BndEvt__Button_Blueprint_Hitbox_K2Node_ComponentBoundEvent_9_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABeginSpeechButton_C__pf2198246146::bpf__ExecuteUbergraph_BeginSpeechButton__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, AStopSpeechButton_C__pf2198246146::StaticClass(), /*out*/ TArrayCaster<AStopSpeechButton_C__pf2198246146*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Get<AActor*>());
			}
		case 3:
			{
				...
				b0l__K2Node_DynamicCast_AsStop_Speech_Button__pf = Cast<AStopSpeechButton_C__pf2198246146>(b0l__CallFunc_Array_Get_Item_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsStop_Speech_Button__pf != nullptr);;
		...
		case 4:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsStop_Speech_Button__pf))
				{
					b0l__K2Node_DynamicCast_AsStop_Speech_Button__pf->SetActorHiddenInGame(false);
				}
			}
		case 5:
			{
				(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(this, AMotionControllerPawn_C__pf3611121690::StaticClass(), /*out*/ TArrayCaster<AMotionControllerPawn_C__pf3611121690*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf).Get<AActor*>());
			}
		case 6:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf != nullptr);;
		...
		case 7:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf->bpv__SpeechOn__pf = true;
				}
			}
		case 8:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_7__pf = (b0l__K2Node_DynamicCast_AsMenu_GI_1__pf != nullptr);;
		...
		case 9:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI_1__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI_1__pf->bpv__StutterButtonOn__pf) : (__Local__25)))
				{
					__CurrentState = 13;
					break;
				}
		...
		case 10:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, ABeginStutterButton_C__pf2552470103::StaticClass(), /*out*/ TArrayCaster<ABeginStutterButton_C__pf2552470103*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_3__pf).Get<AActor*>());
			}
		case 11:
			{
				...
				b0l__K2Node_DynamicCast_AsBegin_Stutter_Button__pf = Cast<ABeginStutterButton_C__pf2552470103>(b0l__CallFunc_Array_Get_Item_3__pf);
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsBegin_Stutter_Button__pf != nullptr);;
		...
		case 12:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsBegin_Stutter_Button__pf->SetActorHiddenInGame(false);
				}
			}
		case 13:
			{
		...
		case 14:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(15, 597607732, TEXT("ExecuteUbergraph_BeginSpeechButton_0"), this));
				__CurrentState = -1;
				break;
			}
		case 15:
		...
		case 21:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsRecording_Test__pf->bpf__CalledByButtonStart__pf();
				}
			}
		case 22:
			{
				(b0l__CallFunc_GetAllActorsOfClass_OutActors_4__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(this, ARecording_Test_1_C__pf1711902218::StaticClass(), /*out*/ TArrayCaster<ARecording_Test_1_C__pf1711902218*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_4__pf).Get<AActor*>());
			}
		case 23:
			{
				...
				b0l__K2Node_DynamicCast_AsRecording_Test_1__pf = Cast<ARecording_Test_1_C__pf1711902218>(b0l__CallFunc_Array_Get_Item_4__pf);
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsRecording_Test_1__pf != nullptr);;
		...
		case 24:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsRecording_Test_1__pf->bpf__CalledByButtonStart__pf();
				}
			}
		case 25:
			{
		...
		case 26:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_6__pf = (b0l__K2Node_DynamicCast_AsMenu_GI__pf != nullptr);;
		...
		case 27:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpf__SetAttemptNumberByStartSpeech__pf();
				}
			}
		case 28:
			{
				if(::IsValid(bpv__HitboxButton__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__HitboxButton__pf->USceneComponent::K2_GetComponentLocation();
				}
		...
		case 30:
			{
				UKismetSystemLibrary::MoveComponentTo(bpv__ButtonxTop__pfT, FVector(0.000000,0.000000,38.000000), FRotator(0.000000,0.000000,0.000000), false, false, 0.000000, false, b0l__Temp_byte_Variable__pf, FLatentActionInfo(31, 1150286823, TEXT("ExecuteUbergraph_BeginSpeechButton_0"), this));
				__CurrentState = -1;
				break;
			}
		case 31:
		...
		case 34:
			{
				UKismetSystemLibrary::Delay(this, 0.350000, FLatentActionInfo(35, -1545433333, TEXT("ExecuteUbergraph_BeginSpeechButton_0"), this));
				__CurrentState = -1;
				break;
			}
		case 35:
		...
		case 39:
			{
				UKismetSystemLibrary::MoveComponentTo(bpv__ButtonxTop__pfT, FVector(0.000000,0.000000,68.000000), FRotator(0.000000,0.000000,0.000000), false, false, 0.000000, false, b0l__Temp_byte_Variable_1__pf, FLatentActionInfo(1, -1068882560, TEXT("ExecuteUbergraph_BeginSpeechButton_0"), this));
				__CurrentState = -1;
				break;
			}
		case 50:
...
void ABeginSpeechButton_C__pf2198246146::bpf__ExecuteUbergraph_BeginSpeechButton__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 41:
			{
				bpv__initializing__pf = true;
			}
		case 42:
			{
				(b0l__CallFunc_GetAllActorsOfClassWithTag_OutActors__pf).Reset();
				UGameplayStatics::GetAllActorsOfClassWithTag(this, ATriggerBoxMainWorld_C__pf2552470103::StaticClass(), FName(TEXT("Rater")), /*out*/ TArrayCaster<ATriggerBoxMainWorld_C__pf2552470103*>(b0l__CallFunc_GetAllActorsOfClassWithTag_OutActors__pf).Get<AActor*>());
			}
		case 43:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClassWithTag_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_5__pf);
				b0l__K2Node_DynamicCast_AsTrigger_Box_Main_World__pf = Cast<ATriggerBoxMainWorld_C__pf2552470103>(b0l__CallFunc_Array_Get_Item_5__pf);
				b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsTrigger_Box_Main_World__pf != nullptr);;
		...
		case 44:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsTrigger_Box_Main_World__pf))
				{
					b0l__K2Node_DynamicCast_AsTrigger_Box_Main_World__pf->SetActorHiddenInGame(true);
				}
			}
		case 45:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsTrigger_Box_Main_World__pf))
				{
					b0l__K2Node_DynamicCast_AsTrigger_Box_Main_World__pf->AActor::SetActorEnableCollision(false);
				}
			}
		case 46:
			{
				...
				UKismetMathLibrary::BreakVector(b0l__CallFunc_BreakTransform_Location__pf, /*out*/ b0l__CallFunc_BreakVector_X_2__pf, /*out*/ b0l__CallFunc_BreakVector_Y_2__pf, /*out*/ b0l__CallFunc_BreakVector_Z_2__pf);
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(b0l__CallFunc_BreakVector_X_2__pf, b0l__CallFunc_BreakVector_Y_2__pf, b0l__CallFunc_BreakVector_Z_2__pf);
		...
		case 47:
			{
				...
				UKismetMathLibrary::BreakTransform(bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf, /*out*/ b0l__CallFunc_BreakTransform_Location__pf, /*out*/ b0l__CallFunc_BreakTransform_Rotation__pf, /*out*/ b0l__CallFunc_BreakTransform_Scale__pf);
				UKismetMathLibrary::BreakVector(b0l__CallFunc_BreakTransform_Location__pf, /*out*/ b0l__CallFunc_BreakVector_X_2__pf, /*out*/ b0l__CallFunc_BreakVector_Y_2__pf, /*out*/ b0l__CallFunc_BreakVector_Z_2__pf);
				bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(b0l__CallFunc_BreakVector_Z_2__pf, 5.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(b0l__CallFunc_BreakVector_X_2__pf, b0l__CallFunc_BreakVector_Y_2__pf, bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf);
				bpv__DownLocation__pf = bpfv__CallFunc_MakeVector_ReturnValue_1__pf;
				__CurrentState = -1;
				break;
			}
		case 52:
		...
		case 53:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(40, -1268490119, TEXT("ExecuteUbergraph_BeginSpeechButton_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ABeginSpeechButton_C__pf2198246146::bpf__ExecuteUbergraph_BeginSpeechButton__pf_2(int32 bpp__EntryPoint__pf)
{
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 55:
			{
				...
				{
					__Local__31 = (AActor::StaticClass())->FindPropertyByName(FName(TEXT("bHidden")));
					check(__Local__31);
					__Local__32 = __Local__31;
				}
				if (!(((FBoolProperty*)__Local__31)->GetPropertyValue_InContainer((this), 0)))
				{
					__CurrentState = 57;
					break;
				}
		...
		case 57:
			{
				UKismetSystemLibrary::Delay(this, 1.000000, FLatentActionInfo(48, 607750955, TEXT("ExecuteUbergraph_BeginSpeechButton_2"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ABeginSpeechButton_C__pf2198246146::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BeginSpeechButton__pf_2(54);
}
void ABeginSpeechButton_C__pf2198246146::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BeginSpeechButton__pf_1(52);
}
void ABeginSpeechButton_C__pf2198246146::bpf__BndEvt__Button_Blueprint_Hitbox_K2Node_ComponentBoundEvent_9_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BeginSpeechButton__pf_0(50);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABeginSpeechButton_C__pf2198246146::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABeginSpeechButton_C__pf2198246146::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{239, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Pre-Fabs/CompleteModels/StopSpeechButton.StopSpeechButton_C 
		...
		{240, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Pre-Fabs/TriggerBoxMainWorld.TriggerBoxMainWorld_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABeginSpeechButton_C__pf2198246146
{
	FRegisterHelper__ABeginSpeechButton_C__pf2198246146()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Pre-Fabs/CompleteModels/BeginSpeechButton"), &ABeginSpeechButton_C__pf2198246146::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABeginSpeechButton_C__pf2198246146 Instance;
};
FRegisterHelper__ABeginSpeechButton_C__pf2198246146 FRegisterHelper__ABeginSpeechButton_C__pf2198246146::Instance;
