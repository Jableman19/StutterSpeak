...
UFloppy_Text_C__pf2075166221::UFloppy_Text_C__pf2075166221(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__TextBlock_0__pf = nullptr;
	bpv__OrignalxName__pfT = FString(TEXT(""));
	bpv__FloppyxName__pfT = FString(TEXT("[Speech Name Here]"));
	bpv__Reset__pf = false;
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UFloppy_Text_C__pf2075166221::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UFloppy_Text_C__pf2075166221::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_4"), (EObjectFlags)0x00280008);
	__Local__3->LayoutData.Offsets.Right = 275.000000f;
	__Local__3->LayoutData.Offsets.Bottom = 250.000000f;
	__Local__3->Parent = __Local__1;
	auto __Local__4 = NewObject<UBorder>(__Local__0, TEXT("Border_0"), (EObjectFlags)0x00280008);
	__Local__4->HorizontalAlignment = EHorizontalAlignment::HAlign_Center;
	__Local__4->VerticalAlignment = EVerticalAlignment::VAlign_Center;
	auto& __Local__5 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__4->Background.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__5 = FLinearColor(1.000000, 1.000000, 1.000000, 0.000000);
	...
	auto __Local__7 = NewObject<UBorderSlot>(__Local__4, TEXT("BorderSlot_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__10 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_0"), (EObjectFlags)0x00280008);
	__Local__10->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[7A32954643C6003AD7644BA4F60AB41A]\", \"8DAADC4A4EC90B93BA9029958C9D21C0\", \"[Placeholder Text]\")")	);
	...
	{
		__Local__13 = (UTextLayoutWidget::StaticClass())->FindPropertyByName(FName(TEXT("AutoWrapText")));
		check(__Local__13);
		__Local__14 = __Local__13;
	}
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((__Local__10), true, 0));
...
PRAGMA_ENABLE_OPTIMIZATION
void UFloppy_Text_C__pf2075166221::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__15;
	SlotNames.Append(__Local__15);
}
void UFloppy_Text_C__pf2075166221::InitializeNativeClassData()
{
	...
	__Local__18.ObjectName = FString(TEXT("TextBlock_0"));
	__Local__18.PropertyName = FName(TEXT("Text"));
	...
	__Local__20.Name = FName(TEXT("Floppy Name"));
	__Local__18.Kind = EBindingKind::Property;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UFloppy_Text_C__pf2075166221::StaticClass())->MiscConvertedSubobjects[0]), __Local__16, __Local__17);
}
void UFloppy_Text_C__pf2075166221::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UFloppy_Text_C__pf2075166221::bpf__ExecuteUbergraph_Floppy_Text__pf_0(int32 bpp__EntryPoint__pf)
{
		...
		case 2:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, AReset_Data_Base2_Blueprint_C__pf3730827578::StaticClass(), /*out*/ TArrayCaster<AReset_Data_Base2_Blueprint_C__pf3730827578*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 3:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_AsReset_Data_Base_2_Blueprint__pf = Cast<AReset_Data_Base2_Blueprint_C__pf3730827578>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsReset_Data_Base_2_Blueprint__pf != nullptr);;
		...
		case 4:
			{
				...
				{
					bpfv__CallFunc_GetWidget_ReturnValue__pf = b0l__K2Node_DynamicCast_AsReset_Data_Base_2_Blueprint__pf->bpv__Widget__pf->GetWidget();
				}
				b0l__K2Node_DynamicCast_AsReset_Button_Display__pf = Cast<UReset_Button_Display_C__pf4267528607>(bpfv__CallFunc_GetWidget_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsReset_Button_Display__pf != nullptr);;
		...
		case 5:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsReset_Button_Display__pf->bpf__EnableDisplayByFloppyText__pf(bpv__OrignalxName__pfT);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 7:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__DataxtoxSavexxxSpeechxName__pfTTT3TT = bpv__OrignalxName__pfT;
				}
			}
		case 8:
			{
		...
		case 9:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf))
				{
					b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpf__MenuGIDataLoadedByFloppyText__pf();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void UFloppy_Text_C__pf2075166221::bpf__StoreSpeechNameByProjector__pf()
{
	bpf__ExecuteUbergraph_Floppy_Text__pf_0(10);
}
PRAGMA_DISABLE_OPTIMIZATION
void UFloppy_Text_C__pf2075166221::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UFloppy_Text_C__pf2075166221::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UFloppy_Text_C__pf2075166221
{
	FRegisterHelper__UFloppy_Text_C__pf2075166221()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Widgets/Floppy_Text"), &UFloppy_Text_C__pf2075166221::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UFloppy_Text_C__pf2075166221 Instance;
};
FRegisterHelper__UFloppy_Text_C__pf2075166221 FRegisterHelper__UFloppy_Text_C__pf2075166221::Instance;
