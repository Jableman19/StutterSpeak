...
AMusicManager_Blueprint_C__pf1711902218::AMusicManager_Blueprint_C__pf1711902218(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AMusicManager_Blueprint_C__pf1711902218::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AMusicManager_Blueprint_C__pf1711902218::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AMusicManager_Blueprint_C__pf1711902218::bpf__ExecuteUbergraph_MusicManager_Blueprint__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 5:
			{
				bpfv__CallFunc_IsValid_ReturnValue_2__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf);
		...
		case 6:
			{
				if(::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf))
				{
					b0l__CallFunc_CreateSound2D_ReturnValue__pf->Play(0.000000);
				}
				__CurrentState = -1;
				break;
			}
		...
		case 9:
			{
				...
				if (!((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__MenuMusic__pf) : (__Local__3)))
				{
					__CurrentState = 12;
					break;
				}
		...
		case 10:
			{
				b0l__CallFunc_CreateSound2D_ReturnValue__pf = UGameplayStatics::CreateSound2D(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AMusicManager_Blueprint_C__pf1711902218::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), 1.000000, 1.000000, 0.000000, ((USoundConcurrency*)nullptr), false, false);
			}
		case 11:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(4, -511189208, TEXT("ExecuteUbergraph_MusicManager_Blueprint_0"), this));
				__CurrentState = -1;
				break;
			}
		case 12:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf);
		...
		case 13:
			{
				if(::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf))
				{
					b0l__CallFunc_CreateSound2D_ReturnValue__pf->FadeOut(0.250000, 0.000000, EAudioFaderCurve::Linear);
				}
			}
		case 14:
			{
				if(::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf))
				{
					b0l__CallFunc_CreateSound2D_ReturnValue__pf->UActorComponent::K2_DestroyComponent(this);
				}
				__CurrentState = -1;
				break;
			}
...
void AMusicManager_Blueprint_C__pf1711902218::bpf__ExecuteUbergraph_MusicManager_Blueprint__pf_1(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_IsValid_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf);
	...
	if(::IsValid(b0l__CallFunc_CreateSound2D_ReturnValue__pf))
	{
		b0l__CallFunc_CreateSound2D_ReturnValue__pf->FadeOut(2.500000, 0.000000, EAudioFaderCurve::Linear);
	}
	return; //KCST_EndOfThread
}
void AMusicManager_Blueprint_C__pf1711902218::bpf__MusicFade__pf()
{
	bpf__ExecuteUbergraph_MusicManager_Blueprint__pf_1(1);
}
void AMusicManager_Blueprint_C__pf1711902218::bpf__MenuMusicCall__pf()
{
	bpf__ExecuteUbergraph_MusicManager_Blueprint__pf_0(15);
}
void AMusicManager_Blueprint_C__pf1711902218::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_MusicManager_Blueprint__pf_0(7);
}
PRAGMA_DISABLE_OPTIMIZATION
void AMusicManager_Blueprint_C__pf1711902218::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AMusicManager_Blueprint_C__pf1711902218::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AMusicManager_Blueprint_C__pf1711902218
{
	FRegisterHelper__AMusicManager_Blueprint_C__pf1711902218()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Managers/MusicManager_Blueprint"), &AMusicManager_Blueprint_C__pf1711902218::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AMusicManager_Blueprint_C__pf1711902218 Instance;
};
FRegisterHelper__AMusicManager_Blueprint_C__pf1711902218 FRegisterHelper__AMusicManager_Blueprint_C__pf1711902218::Instance;
