...
#include "BPSpeechWorld__pf2075166221.h"
#include "SpeechPageW__pf1694860710.h"
#include "MenuGI__pf3730827578.h"
#include "Microphone_MainMic_Blueprint__pf3730827578.h"
...
AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Timer__pf = 0.000000f;
	bpv__CurrentxPagexNumber__pfTT = 0;
	bpv__AllxStuttersxinxSpeech__pfTTT = TArray<FStutter_Struct__pf3774553483> ();
	bpv__TotalxLengthxofxStuttering__pfTTT = 0.000000f;
	bpv__TimerOn__pf = false;
...
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ABPSpeechWorld_C__pf2075166221::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(USpeechPageW_C__pf1694860710::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UMenuGI_C__pf3730827578::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass());
	// List of all referenced converted structures
	extern UScriptStruct* Z_Construct_UScriptStruct_FStutter_Struct__pf3774553483();
	InDynamicClass->ReferencedConvertedFields.Add(Z_Construct_UScriptStruct_FStutter_Struct__pf3774553483());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	UKismetSystemLibrary::K2_PauseTimer(this, FString(TEXT("Duration Tracker")));
	(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, ABPSpeechWorld_C__pf2075166221::StaticClass(), /*out*/ TArrayCaster<ABPSpeechWorld_C__pf2075166221*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
	FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
	b0l__K2Node_DynamicCast_AsBPSpeech_World__pf = Cast<ABPSpeechWorld_C__pf2075166221>(b0l__CallFunc_Array_Get_Item__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBPSpeech_World__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsBPSpeech_World__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsBPSpeech_World__pf->bpv__Widget__pf))
	{
		bpfv__CallFunc_GetWidget_ReturnValue__pf = b0l__K2Node_DynamicCast_AsBPSpeech_World__pf->bpv__Widget__pf->GetWidget();
	}
	b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf = Cast<USpeechPageW_C__pf1694860710>(bpfv__CallFunc_GetWidget_ReturnValue__pf);
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_1__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	b0l__K2Node_MakeStruct_Stutter_Struct__pf.bpv__LengthofStutter_10_3F74E2144F55F376EE07BAADF6F2E65B__pf = bpv__Timer__pf;
	int32  __Local__3 = 0;
	b0l__K2Node_MakeStruct_Stutter_Struct__pf.bpv__Page_11_12EAE8BB4034C43FAA8A91ABD4A05BA3__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf)) ? (b0l__K2Node_DynamicCast_AsSpeech_Page_W__pf->bpv__PageNum__pf) : (__Local__3));
	bpv__CurrentxStutter__pfT = b0l__K2Node_MakeStruct_Stutter_Struct__pf;
	bpfv__CallFunc_Array_Add_ReturnValue__pf = FCustomThunkTemplates::Array_Add(bpv__AllxStuttersxinxSpeech__pfTTT, bpv__CurrentxStutter__pfT);
	(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass(), /*out*/ TArrayCaster<AMicrophone_MainMic_Blueprint_C__pf3730827578*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf).Get<AActor*>());
	...
	b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint_1__pf = Cast<AMicrophone_MainMic_Blueprint_C__pf3730827578>(b0l__CallFunc_Array_Get_Item_3__pf);
	b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint_1__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_5__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint_1__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint_1__pf->bpv__RingMesh__pf))
	{
		b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint_1__pf->bpv__RingMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
	}
	return; //KCST_EndOfThread
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_K2_SetTimer_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimer(this, FString(TEXT("Duration Tracker")), 0.100000, true, 0.000000, 0.000000);
	bpv__TimerOn__pf = true;
	...
	if (!((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI_1__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI_1__pf->bpv__MicrophoneColor__pf) : (__Local__4)))
	{
		return; //KCST_EndOfThreadIfNot
	}
	(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, AMicrophone_MainMic_Blueprint_C__pf3730827578::StaticClass(), /*out*/ TArrayCaster<AMicrophone_MainMic_Blueprint_C__pf3730827578*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Get<AActor*>());
	...
	b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint__pf = Cast<AMicrophone_MainMic_Blueprint_C__pf3730827578>(b0l__CallFunc_Array_Get_Item_2__pf);
	b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_4__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint__pf->bpv__RingMesh__pf))
	{
		b0l__K2Node_DynamicCast_AsMicrophone_Main_Mic_Blueprint__pf->bpv__RingMesh__pf->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	}
	return; //KCST_EndOfThread
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				FCustomThunkTemplates::Array_Get(bpv__AllxStuttersxinxSpeech__pfTTT, b0l__Temp_int_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__TotalxLengthxofxStuttering__pfTTT, b0l__CallFunc_Array_Get_Item_1__pf.bpv__LengthofStutter_10_3F74E2144F55F376EE07BAADF6F2E65B__pf);
				bpv__TotalxLengthxofxStuttering__pfTTT = bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf;
		...
		case 4:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__AllxStuttersxinxSpeech__pfTTT);
		...
		case 5:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsMenu_GI__pf != nullptr);;
		...
		case 6:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__DataxtoxSavexxxTotalxTimexStuttering__pfTTT3TTT = bpv__TotalxLengthxofxStuttering__pfTTT;
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	bpv__Timer__pf = 0.000000;
	bpv__TimerOn__pf = false;
	return; //KCST_EndOfThread
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__GetxTotalxStutterxTime__pfTTT()
{
	bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_2(31);
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__ClearxTimer__pfT()
{
	bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_3(27);
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__StopxTimer__pfT()
{
	bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_0(16);
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__StartxTimer__pfT()
{
	bpf__ExecuteUbergraph_Stutter_Timer__Empty_Object__Blueprint__pf_1(8);
}
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::bpf__DurationxTracker__pfT()
{
	FString bpfv__CallFunc_Conv_FloatToString_ReturnValue__pf{};
	float bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf{};
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__Timer__pf, 0.100000);
	bpv__Timer__pf = bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf;
	bpfv__CallFunc_Conv_FloatToString_ReturnValue__pf = UKismetStringLibrary::Conv_FloatToString(bpv__Timer__pf);
...
PRAGMA_DISABLE_OPTIMIZATION
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{159, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/BPSpeechWorld.BPSpeechWorld_C 
		{146, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/Speech_World/SpeechPageW.SpeechPageW_C 
		...
		{160, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Blueprints/Microphone_MainMic_Blueprint.Microphone_MainMic_Blueprint_C 
		{161, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UserDefinedStruct /Game/Stutter_Speak_Content/Structs/Stutter_Struct.Stutter_Struct 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218
{
	FRegisterHelper__AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Managers/Stutter_Timer__Empty_Object__Blueprint"), &AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218 Instance;
};
FRegisterHelper__AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218 FRegisterHelper__AStutter_Timer__Empty_Object__Blueprint_C__pf1711902218::Instance;
