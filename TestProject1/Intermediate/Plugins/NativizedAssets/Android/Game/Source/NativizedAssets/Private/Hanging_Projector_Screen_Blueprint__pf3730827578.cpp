...
#include "RaterBP__pf1694860710.h"
#include "ResultsDataBP__pf1694860710.h"
#include "FluencyRaterBP1__pf1694860710.h"
...
AHanging_Projector_Screen_Blueprint_C__pf3730827578::AHanging_Projector_Screen_Blueprint_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AHanging_Projector_Screen_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__0->OverrideMaterials = TArray<UMaterialInterface*> ();
		__Local__0->OverrideMaterials.Reserve(2);
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AHanging_Projector_Screen_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AHanging_Projector_Screen_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	auto& __Local__4 = (*(AccessPrivateProperty<TSubclassOf<UUserWidget>  >((bpv__Widget__pf), UWidgetComponent::__PPO__WidgetClass() )));
	__Local__4 = URaterBP_C__pf1694860710::StaticClass();
	auto& __Local__5 = (*(AccessPrivateProperty<FIntPoint >((bpv__Widget__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__5.X = 1920;
	__Local__5.Y = 1080;
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__6 = FVector(-0.494630, 2.467344, -0.298866);
	auto& __Local__7 = (*(AccessPrivateProperty<FRotator >((bpv__Widget__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__7 = FRotator(0.000000, 180.000000, 0.000000);
	auto& __Local__8 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__8 = FVector(0.250000, 0.250000, 0.250000);
	...
	(((FBoolProperty*)__Local__9)->SetPropertyValue_InContainer((bpv__Widget__pf), true, 0));
	bpv__FluencyxRater__pfT = nullptr;
	bpv__EffectivenessxRater__pfT = nullptr;
	bpv__ResultsxData__pfT = nullptr;
...
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(URaterBP_C__pf1694860710::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UResultsDataBP_C__pf1694860710::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UFluencyRaterBP1_C__pf1694860710::StaticClass());
	...
	(((FBoolProperty*)__Local__14)->SetPropertyValue_InContainer((__Local__13), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_Hanging_Projector_Screen_Blueprint__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 10);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__Widget__pf))
	{
		bpv__Widget__pf->SetWidget(bpv__ResultsxData__pfT);
	}
	return; // KCST_GotoReturn
}
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_Hanging_Projector_Screen_Blueprint__pf_1(int32 bpp__EntryPoint__pf)
{
	UResultsDataBP_C__pf1694860710* bpfv__CallFunc_Create_ReturnValue__pf{};
	UUserWidget* bpfv__CallFunc_GetWidget_ReturnValue__pf{};
	UFluencyRaterBP1_C__pf1694860710* bpfv__CallFunc_Create_ReturnValue_1__pf{};
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Create_ReturnValue_1__pf = CastChecked<UFluencyRaterBP1_C__pf1694860710>(UWidgetBlueprintLibrary::Create(this, UFluencyRaterBP1_C__pf1694860710::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	bpv__FluencyxRater__pfT = bpfv__CallFunc_Create_ReturnValue_1__pf;
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UResultsDataBP_C__pf1694860710>(UWidgetBlueprintLibrary::Create(this, UResultsDataBP_C__pf1694860710::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	bpv__ResultsxData__pfT = bpfv__CallFunc_Create_ReturnValue__pf;
	if(::IsValid(bpv__Widget__pf))
	{
		bpfv__CallFunc_GetWidget_ReturnValue__pf = bpv__Widget__pf->GetWidget();
	}
	bpv__EffectivenessxRater__pfT = bpfv__CallFunc_GetWidget_ReturnValue__pf;
	// optimized KCST_UnconditionalGoto
	SetActorHiddenInGame(true);
	return; // KCST_GotoReturn
}
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_Hanging_Projector_Screen_Blueprint__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 8);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__Widget__pf))
	{
		bpv__Widget__pf->SetWidget(bpv__FluencyxRater__pfT);
	}
	return; // KCST_GotoReturn
}
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::bpf__DisplayResults__pf()
{
	bpf__ExecuteUbergraph_Hanging_Projector_Screen_Blueprint__pf_0(10);
}
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::bpf__ChangeWidget__pf()
{
	bpf__ExecuteUbergraph_Hanging_Projector_Screen_Blueprint__pf_2(8);
}
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Hanging_Projector_Screen_Blueprint__pf_1(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AHanging_Projector_Screen_Blueprint_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{210, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/Speech_World/RaterBP.RaterBP_C 
		...
		{212, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/Speech_World/FluencyRaterBP1.FluencyRaterBP1_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AHanging_Projector_Screen_Blueprint_C__pf3730827578
{
	FRegisterHelper__AHanging_Projector_Screen_Blueprint_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Hanging_Projector_Screen_Blueprint"), &AHanging_Projector_Screen_Blueprint_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AHanging_Projector_Screen_Blueprint_C__pf3730827578 Instance;
};
FRegisterHelper__AHanging_Projector_Screen_Blueprint_C__pf3730827578 FRegisterHelper__AHanging_Projector_Screen_Blueprint_C__pf3730827578::Instance;
