...
AActive_Choice_Ring_C__pf3041421614::AActive_Choice_Ring_C__pf3041421614(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__ActivexRing__pfT = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Active Ring"));
	...
	bpv__ActivexRing__pfT->CreationMethod = EComponentCreationMethod::Native;
	bpv__ActivexRing__pfT->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__ActivexRing__pfT), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AActive_Choice_Ring_C__pf3041421614::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ActivexRing__pfT->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ActivexRing__pfT->OverrideMaterials.Reserve(1);
	bpv__ActivexRing__pfT->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AActive_Choice_Ring_C__pf3041421614::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__ActivexRing__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(-0.000002, 0.000000, 0.469010);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__ActivexRing__pfT), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(0.027200, 0.027200, 0.001000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__ActivexRing__pfT), true, 0));
	bpv__Needed__pf = false;
	bpv__StartingxLocation__pfT = FVector(0.000000, 0.000000, 0.000000);
	bpv__StartingxRotation__pfT = FRotator(0.000000, 0.000000, 0.000000);
...
void AActive_Choice_Ring_C__pf3041421614::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__ActivexRing__pfT)
	{
		bpv__ActivexRing__pfT->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AActive_Choice_Ring_C__pf3041421614::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AActive_Choice_Ring_C__pf3041421614::bpf__ExecuteUbergraph_Active_Choice_Ring__pf_0(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf(EForceInit::ForceInit);
	bool bpfv__CallFunc_NotEqualExactly_VectorVector_ReturnValue__pf{};
	...
	bpfv__CallFunc_NotEqualExactly_VectorVector_ReturnValue__pf = UKismetMathLibrary::NotEqualExactly_VectorVector(bpv__StartingxLocation__pfT, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf);
	if (!bpfv__CallFunc_NotEqualExactly_VectorVector_ReturnValue__pf)
	{
		return; //KCST_EndOfThreadIfNot
	}
	...
	{
		b0l__K2Node_DynamicCast_AsConfirm_Rating_Button__pf->bpf__Enable__pf();
	}
	bpv__Needed__pf = false;
	return; //KCST_EndOfThread
}
void AActive_Choice_Ring_C__pf3041421614::bpf__ExecuteUbergraph_Active_Choice_Ring__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 17);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__DefaultSceneRoot__pf))
	{
		bpv__DefaultSceneRoot__pf->USceneComponent::K2_SetWorldLocationAndRotation(bpv__StartingxLocation__pfT, bpv__StartingxRotation__pfT, false, /*out*/ b0l__CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult__pf, false);
	}
	bpv__Needed__pf = true;
	return; //KCST_EndOfThread
}
void AActive_Choice_Ring_C__pf3041421614::bpf__ExecuteUbergraph_Active_Choice_Ring__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	bpv__StartingxLocation__pfT = bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf;
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__DefaultSceneRoot__pf))
	{
		bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpv__DefaultSceneRoot__pf->USceneComponent::K2_GetComponentRotation();
	}
	bpv__StartingxRotation__pfT = bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf;
	return; //KCST_EndOfThread
}
void AActive_Choice_Ring_C__pf3041421614::bpf__ExecuteUbergraph_Active_Choice_Ring__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				FVector  __Local__6 = FVector(0.000000,0.000000,0.000000);
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(((::IsValid(bpv__DefaultSceneRoot__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__DefaultSceneRoot__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__6)), FVector(0.000000,0.000000,15.000000));
				FRotator  __Local__7 = FRotator(0.000000,0.000000,0.000000);
				UKismetSystemLibrary::MoveComponentTo(bpv__DefaultSceneRoot__pf, bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf, ((::IsValid(bpv__DefaultSceneRoot__pf)) ? ((*(AccessPrivateProperty<FRotator >((bpv__DefaultSceneRoot__pf), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__7)), false, false, 1.000000, false, b0l__Temp_byte_Variable__pf, FLatentActionInfo(1, -1790556570, TEXT("ExecuteUbergraph_Active_Choice_Ring_3"), this));
				__CurrentState = -1;
				break;
			}
		case 7:
...
void AActive_Choice_Ring_C__pf3041421614::bpf__ResetLocationByConfirm__pf()
{
	bpf__ExecuteUbergraph_Active_Choice_Ring__pf_1(17);
}
void AActive_Choice_Ring_C__pf3041421614::bpf__GetLocationByLevelBlueprint__pf()
{
	bpf__ExecuteUbergraph_Active_Choice_Ring__pf_2(16);
}
void AActive_Choice_Ring_C__pf3041421614::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_Active_Choice_Ring__pf_0(9);
}
void AActive_Choice_Ring_C__pf3041421614::bpf__LowerButton__pf()
{
	bpf__ExecuteUbergraph_Active_Choice_Ring__pf_3(7);
}
PRAGMA_DISABLE_OPTIMIZATION
void AActive_Choice_Ring_C__pf3041421614::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AActive_Choice_Ring_C__pf3041421614::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AActive_Choice_Ring_C__pf3041421614
{
	FRegisterHelper__AActive_Choice_Ring_C__pf3041421614()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Rating_Buttons/Active_Choice_Ring"), &AActive_Choice_Ring_C__pf3041421614::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AActive_Choice_Ring_C__pf3041421614 Instance;
};
FRegisterHelper__AActive_Choice_Ring_C__pf3041421614 FRegisterHelper__AActive_Choice_Ring_C__pf3041421614::Instance;
