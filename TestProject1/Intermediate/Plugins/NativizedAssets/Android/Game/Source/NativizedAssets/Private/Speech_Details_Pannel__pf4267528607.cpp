...
USpeech_Details_Pannel_C__pf4267528607::USpeech_Details_Pannel_C__pf4267528607(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__SpeechTitle__pf = nullptr;
	bpv__Switcher__pf = nullptr;
	bpv__SpeechxName__pfT = FString(TEXT("(Speech Name)"));
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void USpeech_Details_Pannel_C__pf4267528607::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void USpeech_Details_Pannel_C__pf4267528607::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__3->LayoutData.Offsets.Left = 712.000000f;
	__Local__3->LayoutData.Offsets.Top = 24.000000f;
	__Local__3->LayoutData.Offsets.Right = 500.000000f;
	__Local__3->LayoutData.Offsets.Bottom = 104.864868f;
	__Local__3->Parent = __Local__1;
	auto __Local__4 = NewObject<UTextBlock>(__Local__0, TEXT("SpeechTitle"), (EObjectFlags)0x00280008);
	__Local__4->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[D19922B449932B66F70C14B5B00E3162]\", \"DE22F05A419B3F64D378ED9CFF939D7B\", \"Default Text\")")	);
	__Local__4->Font.OutlineSettings.OutlineSize = 3;
	__Local__4->Font.Size = 67;
	...
	auto __Local__6 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_9"), (EObjectFlags)0x00280008);
	__Local__6->LayoutData.Offsets.Left = 184.000000f;
	__Local__6->LayoutData.Offsets.Top = 160.000000f;
	__Local__6->LayoutData.Offsets.Right = 1604.000000f;
	__Local__6->LayoutData.Offsets.Bottom = 819.284302f;
	__Local__6->Parent = __Local__1;
	auto __Local__7 = NewObject<USwitcher_C__pf517162645>(__Local__0, TEXT("Switcher"), (EObjectFlags)0x00280008);
...
PRAGMA_ENABLE_OPTIMIZATION
void USpeech_Details_Pannel_C__pf4267528607::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__8;
	SlotNames.Append(__Local__8);
}
void USpeech_Details_Pannel_C__pf4267528607::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__9;
	TArray<FDelegateRuntimeBinding>  __Local__10;
	__Local__10.AddUninitialized(1);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__10.GetData(), 1);
	auto& __Local__11 = __Local__10[0];
	__Local__11.ObjectName = FString(TEXT("SpeechTitle"));
	__Local__11.PropertyName = FName(TEXT("Text"));
	auto& __Local__12 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__11.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	__Local__12 = TArray<FPropertyPathSegment> ();
	__Local__12.AddUninitialized(1);
	FPropertyPathSegment::StaticStruct()->InitializeStruct(__Local__12.GetData(), 1);
	auto& __Local__13 = __Local__12[0];
	__Local__13.Name = FName(TEXT("Speech Name"));
	__Local__11.Kind = EBindingKind::Property;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(USpeech_Details_Pannel_C__pf4267528607::StaticClass())->MiscConvertedSubobjects[0]), __Local__9, __Local__10);
}
void USpeech_Details_Pannel_C__pf4267528607::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void USpeech_Details_Pannel_C__pf4267528607::bpf__ExecuteUbergraph_Speech_Details_Pannel__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsProjector_Screen_Blueprint__pf->bpf__ShowDetailsByDetailsPanel__pf();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 6:
			{
				...
				bpfv__CallFunc_Len_ReturnValue__pf = UKismetStringLibrary::Len(((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__DataxtoxSavexxxSpeechxName__pfTTT3TT) : (__Local__14)));
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(bpfv__CallFunc_Len_ReturnValue__pf, 30);
		...
		case 7:
			{
				FString  __Local__15 = FString(TEXT(""));
				bpfv__CallFunc_GetSubstring_ReturnValue__pf = UKismetStringLibrary::GetSubstring(((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__DataxtoxSavexxxSpeechxName__pfTTT3TT) : (__Local__15)), 0, 30);
				bpfv__CallFunc_Concat_StrStr_ReturnValue__pf = UKismetStringLibrary::Concat_StrStr(bpfv__CallFunc_GetSubstring_ReturnValue__pf, FString(TEXT("...")));
				bpv__SpeechxName__pfT = bpfv__CallFunc_Concat_StrStr_ReturnValue__pf;
			}
		case 8:
			{
				if(::IsValid(bpv__Switcher__pf))
				{
					bpv__Switcher__pf->bpf__ResetPanelBySpeechDetailsPanel__pf();
				}
				__CurrentState = 1;
				break;
			}
		case 9:
			{
				...
				bpv__SpeechxName__pfT = ((::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf)) ? (b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__DataxtoxSavexxxSpeechxName__pfTTT3TT) : (__Local__16));
				__CurrentState = 8;
				break;
			}
		default:
...
void USpeech_Details_Pannel_C__pf4267528607::bpf__SetSpeechNameByMenuGI__pf()
{
	bpf__ExecuteUbergraph_Speech_Details_Pannel__pf_0(4);
}
PRAGMA_DISABLE_OPTIMIZATION
void USpeech_Details_Pannel_C__pf4267528607::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void USpeech_Details_Pannel_C__pf4267528607::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{23, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  ScriptStruct /Script/SlateCore.ButtonStyle 
		...
		{24, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/UMG.WidgetSwitcher 
		{25, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  ScriptStruct /Script/SlateCore.SlateBrush 
		...
		{28, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  ScriptStruct /Script/SlateCore.SlateSound 
		{29, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/UMG.Button 
		...
		{145, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/Graphing_Widgets/Switcher.Switcher_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__USpeech_Details_Pannel_C__pf4267528607
{
	FRegisterHelper__USpeech_Details_Pannel_C__pf4267528607()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Widgets/Menu_World_Widgets/Speech_Details_Pannel"), &USpeech_Details_Pannel_C__pf4267528607::__StaticDependenciesAssets);
	}
	static FRegisterHelper__USpeech_Details_Pannel_C__pf4267528607 Instance;
};
FRegisterHelper__USpeech_Details_Pannel_C__pf4267528607 FRegisterHelper__USpeech_Details_Pannel_C__pf4267528607::Instance;
