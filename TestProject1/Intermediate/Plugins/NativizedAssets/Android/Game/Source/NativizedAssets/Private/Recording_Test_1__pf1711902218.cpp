...
ARecording_Test_1_C__pf1711902218::ARecording_Test_1_C__pf1711902218(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__AudioCapture__pf->SoundSubmix = CastChecked<USoundSubmixBase>(CastChecked<UDynamicClass>(ARecording_Test_1_C__pf1711902218::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
TEXT("NSLOCTEXT(\"[A79CA1F4419212DC7440F98E506A42E4]\", \"D4A28EDF4CF12385B42C1C849753B960\", \"Recordings\\\\\")")	);
	bpv__Submix__pf = CastChecked<USoundSubmixBase>(CastChecked<UDynamicClass>(ARecording_Test_1_C__pf1711902218::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__12xHourxHour__pfGT = 0;
	bpv__TempRecording__pf = CastChecked<USoundWave>(CastChecked<UDynamicClass>(ARecording_Test_1_C__pf1711902218::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
...
void ARecording_Test_1_C__pf1711902218::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ARecording_Test_1_C__pf1711902218::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ARecording_Test_1_C__pf1711902218::bpf__ExecuteUbergraph_Recording_Test_1__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	UAudioMixerBlueprintLibrary::StartRecordingOutput(this, 0.000000, CastChecked<USoundSubmix>(CastChecked<UDynamicClass>(ARecording_Test_1_C__pf1711902218::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	return; // KCST_GotoReturn
}
void ARecording_Test_1_C__pf1711902218::bpf__ExecuteUbergraph_Recording_Test_1__pf_1(int32 bpp__EntryPoint__pf)
{
	USoundWave* bpfv__CallFunc_StopRecordingOutput_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_StopRecordingOutput_ReturnValue__pf = UAudioMixerBlueprintLibrary::StopRecordingOutput(this, EAudioRecordingExportType::SoundWave, FString(TEXT("")), FString(TEXT("")), CastChecked<USoundSubmix>(CastChecked<UDynamicClass>(ARecording_Test_1_C__pf1711902218::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), ((USoundWave*)nullptr));
	if(::IsValid(bpv__AudioCapture__pf))
	{
		bpv__AudioCapture__pf->USynthComponent::Stop();
	}
	bpv__TempRecording__pf = bpfv__CallFunc_StopRecordingOutput_ReturnValue__pf;
	return; // KCST_GotoReturn
}
void ARecording_Test_1_C__pf1711902218::bpf__CalledByButtonStop__pf()
{
	bpf__ExecuteUbergraph_Recording_Test_1__pf_1(1);
}
void ARecording_Test_1_C__pf1711902218::bpf__CalledByButtonStart__pf()
{
	bpf__ExecuteUbergraph_Recording_Test_1__pf_0(7);
}
PRAGMA_DISABLE_OPTIMIZATION
void ARecording_Test_1_C__pf1711902218::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ARecording_Test_1_C__pf1711902218::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ARecording_Test_1_C__pf1711902218
{
	FRegisterHelper__ARecording_Test_1_C__pf1711902218()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Managers/Recording_Test_1"), &ARecording_Test_1_C__pf1711902218::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ARecording_Test_1_C__pf1711902218 Instance;
};
FRegisterHelper__ARecording_Test_1_C__pf1711902218 FRegisterHelper__ARecording_Test_1_C__pf1711902218::Instance;
