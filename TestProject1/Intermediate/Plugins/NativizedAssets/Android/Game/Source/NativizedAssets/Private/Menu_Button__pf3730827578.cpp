...
#include "Menu_Button__pf3730827578.h"
...
#include "LevelHandler_Blueprint__pf1694860710.h"
...
AMenu_Button_C__pf3730827578::AMenu_Button_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__MenuxButton__pfT = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Menu Button"));
	...
	bpv__MenuxButton__pfT->CreationMethod = EComponentCreationMethod::Native;
	bpv__MenuxButton__pfT->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__MenuxButton__pfT), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AMenu_Button_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__MenuxButton__pfT->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__MenuxButton__pfT->OverrideMaterials.Reserve(1);
	bpv__MenuxButton__pfT->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AMenu_Button_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__MenuxButton__pfT), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.000000, 0.000000, 0.348268);
	auto& __Local__4 = (*(AccessPrivateProperty<FVector >((bpv__MenuxButton__pfT), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__4 = FVector(0.045000, 0.094000, 0.020000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__MenuxButton__pfT), true, 0));
	bpv__TextRender__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__TextRender__pf->AttachToComponent(bpv__MenuxButton__pfT, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__TextRender__pf->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3CDC75314575B9CDACD6738C76B509A8]\", \"F9694DAC4591515A001A20BEC784F361\", \"Menu\")")	);
	...
	__Local__5 = FVector(-29.689447, -28.942047, 51.525749);
	...
	bpv__Sound__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(AMenu_Button_C__pf3730827578::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	__Local__8 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AMenu_Button_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ButtonxBase__pfT->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__ButtonxBase__pfT->OverrideMaterials.Reserve(1);
	bpv__ButtonxBase__pfT->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AMenu_Button_C__pf3730827578::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
...
void AMenu_Button_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AMenu_Button_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ALevelHandler_Blueprint_C__pf1694860710::StaticClass());
	...
	auto& __Local__15 = __Local__14->ComponentDelegateBindings[0];
	__Local__15.ComponentPropertyName = FName(TEXT("Menu Button"));
	__Local__15.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__15.FunctionNameToBind = FName(TEXT("BndEvt__Menu_Button_Menu Button_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AMenu_Button_C__pf3730827578::bpf__ExecuteUbergraph_Menu_Button__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, ALevelHandler_Blueprint_C__pf1694860710::StaticClass(), /*out*/ TArrayCaster<ALevelHandler_Blueprint_C__pf1694860710*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 2:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_AsLevel_Handler_Blueprint__pf = Cast<ALevelHandler_Blueprint_C__pf1694860710>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsLevel_Handler_Blueprint__pf != nullptr);;
		...
		case 3:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsLevel_Handler_Blueprint__pf))
				{
					b0l__K2Node_DynamicCast_AsLevel_Handler_Blueprint__pf->bpf__MenuByWiidget__pf();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 8:
			{
				...
				if(::IsValid(bpv__MenuxButton__pfT))
				{
					bpv__MenuxButton__pfT->USceneComponent::K2_SetRelativeTransform(bpfv__CallFunc_MakeTransform_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeTransform_SweepHitResult_1__pf, false);
				}
			}
		case 9:
			{
		...
		case 14:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(6, 1176514954, TEXT("ExecuteUbergraph_Menu_Button_0"), this));
				__CurrentState = -1;
				break;
			}
		case 15:
		...
		case 17:
			{
				if(::IsValid(bpv__MenuxButton__pfT))
				{
					bpfv__CallFunc_GetRelativeTransform_ReturnValue__pf = bpv__MenuxButton__pfT->USceneComponent::GetRelativeTransform();
				}
		...
		case 20:
			{
				...
				if(::IsValid(bpv__MenuxButton__pfT))
				{
					bpv__MenuxButton__pfT->USceneComponent::K2_SetRelativeTransform(bpfv__CallFunc_MakeTransform_ReturnValue_1__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeTransform_SweepHitResult__pf, false);
				}
			}
		case 21:
			{
		...
		case 24:
			{
				if(::IsValid(bpv__MenuxButton__pfT))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__MenuxButton__pfT->USceneComponent::K2_GetComponentLocation();
				}
...
void AMenu_Button_C__pf3730827578::bpf__ExecuteUbergraph_Menu_Button__pf_1(int32 bpp__EntryPoint__pf)
{
...
void AMenu_Button_C__pf3730827578::bpf__ExecuteUbergraph_Menu_Button__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 11:
			{
				FVector  __Local__17 = FVector(0.000000,0.000000,0.000000);
				bpfv__CallFunc_Add_VectorVector_ReturnValue__pf = UKismetMathLibrary::Add_VectorVector(((::IsValid(bpv__DefaultSceneRoot__pf)) ? ((*(AccessPrivateProperty<FVector >((bpv__DefaultSceneRoot__pf), USceneComponent::__PPO__RelativeLocation() )))) : (__Local__17)), FVector(0.000000,0.000000,15.000000));
				FRotator  __Local__18 = FRotator(0.000000,0.000000,0.000000);
				UKismetSystemLibrary::MoveComponentTo(bpv__DefaultSceneRoot__pf, bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, ((::IsValid(bpv__DefaultSceneRoot__pf)) ? ((*(AccessPrivateProperty<FRotator >((bpv__DefaultSceneRoot__pf), USceneComponent::__PPO__RelativeRotation() )))) : (__Local__18)), false, false, 1.000000, false, b0l__Temp_byte_Variable__pf, FLatentActionInfo(4, -1464939325, TEXT("ExecuteUbergraph_Menu_Button_2"), this));
				__CurrentState = -1;
				break;
			}
		case 26:
...
void AMenu_Button_C__pf3730827578::bpf__BndEvt__Menu_Button_MenuxButton_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature__pfT(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Menu_Button__pf_0(29);
}
void AMenu_Button_C__pf3730827578::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Menu_Button__pf_1(28);
}
void AMenu_Button_C__pf3730827578::bpf__RaiseButton__pf()
{
	bpf__ExecuteUbergraph_Menu_Button__pf_2(27);
}
PRAGMA_DISABLE_OPTIMIZATION
void AMenu_Button_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AMenu_Button_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{225, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Stutter_Speak_Content/Widgets/Speech_World/LevelHandler_Blueprint.LevelHandler_Blueprint_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AMenu_Button_C__pf3730827578
{
	FRegisterHelper__AMenu_Button_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/Menu_Button"), &AMenu_Button_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AMenu_Button_C__pf3730827578 Instance;
};
FRegisterHelper__AMenu_Button_C__pf3730827578 FRegisterHelper__AMenu_Button_C__pf3730827578::Instance;
