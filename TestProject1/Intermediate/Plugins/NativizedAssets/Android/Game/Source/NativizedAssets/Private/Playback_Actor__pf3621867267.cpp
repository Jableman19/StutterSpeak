...
#include "../Plugins/BlueprintFileUtils/Source/BlueprintFileUtils/Public/BlueprintFileUtilsBPLibrary.h"
...
APlayback_Actor_C__pf3621867267::APlayback_Actor_C__pf3621867267(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__MediaSound__pf = CreateDefaultSubobject<UMediaSoundComponent>(TEXT("MediaSound"));
	...
	bpv__MediaSound__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__MediaSound__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UMediaPlayer* >((bpv__MediaSound__pf), UMediaSoundComponent::__PPO__MediaPlayer() )));
	__Local__2 = CastChecked<UMediaPlayer>(CastChecked<UDynamicClass>(APlayback_Actor_C__pf3621867267::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__MediaSound__pf), false, 0));
	bpv__MediaPlayerNode__pf = CastChecked<UMediaPlayer>(CastChecked<UDynamicClass>(APlayback_Actor_C__pf3621867267::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__startTime__pf = 0.000000f;
	bpv__IsPlaying__pf = false;
	bpv__Time__pf = FTimespan(0x0000000000000000);
	bpv__CurrentxSeconds__pfT = 0.000000f;
	bpv__SpeechDur__pf = 0.000000f;
	bpv__RecReady__pf = false;
	bpv__B__pf = FString(TEXT("/sdcard/UE4Game/TestProject1/TestProject1/Content/Movies"));
...
void APlayback_Actor_C__pf3621867267::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__MediaSound__pf)
	{
		bpv__MediaSound__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void APlayback_Actor_C__pf3621867267::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_0(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_FindFiles_ReturnValue__pf{};
	...
	do
	{
		...
		case 4:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("Started Playback")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 5:
			{
		...
		case 7:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_FindFiles_FoundFiles__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_1__pf);
				UKismetSystemLibrary::PrintString(this, b0l__CallFunc_Array_Get_Item_1__pf, true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 30.000000);
			}
		case 8:
			{
				(b0l__CallFunc_FindFiles_FoundFiles__pf).Reset();
				bpfv__CallFunc_FindFiles_ReturnValue__pf = UBlueprintFileUtilsBPLibrary::FindFiles(bpv__B__pf, /*out*/ b0l__CallFunc_FindFiles_FoundFiles__pf, FString(TEXT(".wav")));
				__CurrentState = -1;
				break;
			}
		case 13:
		...
		case 14:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(3, -1655651550, TEXT("ExecuteUbergraph_Playback_Actor_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpv__IsPlaying__pf = false;
	auto __Local__5 = FTimespan{};
	bpfv__CallFunc_GetTotalSeconds_ReturnValue__pf = UKismetMathLibrary::GetTotalSeconds(__Local__5);
	bpv__CurrentxSeconds__pfT = bpfv__CallFunc_GetTotalSeconds_ReturnValue__pf;
	return; //KCST_EndOfThread
}
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_2(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 21);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__MediaPlayerNode__pf))
	{
		bpv__MediaPlayerNode__pf->UMediaPlayer::Close();
	}
	return; //KCST_EndOfThread
}
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_3(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_OpenUrl_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 16);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__MediaPlayerNode__pf))
	{
		bpfv__CallFunc_OpenUrl_ReturnValue__pf = bpv__MediaPlayerNode__pf->UMediaPlayer::OpenUrl(FString(TEXT("")));
	}
	return; //KCST_EndOfThread
}
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_4(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_Pause_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 9);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__MediaPlayerNode__pf))
	{
		bpfv__CallFunc_Pause_ReturnValue__pf = bpv__MediaPlayerNode__pf->UMediaPlayer::Pause();
	}
	return; //KCST_EndOfThread
}
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_5(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_Play_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 11);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__MediaPlayerNode__pf))
	{
		bpfv__CallFunc_Play_ReturnValue__pf = bpv__MediaPlayerNode__pf->UMediaPlayer::Play();
	}
	return; //KCST_EndOfThread
}
void APlayback_Actor_C__pf3621867267::bpf__ExecuteUbergraph_Playback_Actor__pf_6(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 15);
	return; //KCST_EndOfThread
}
void APlayback_Actor_C__pf3621867267::bpf__Close__pf()
{
	bpf__ExecuteUbergraph_Playback_Actor__pf_2(21);
}
void APlayback_Actor_C__pf3621867267::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_Playback_Actor__pf_1(19);
}
void APlayback_Actor_C__pf3621867267::bpf__Seek__pf()
{
	bpf__ExecuteUbergraph_Playback_Actor__pf_6(15);
}
void APlayback_Actor_C__pf3621867267::bpf__RecordOver__pf()
{
	bpf__ExecuteUbergraph_Playback_Actor__pf_0(13);
}
void APlayback_Actor_C__pf3621867267::bpf__Play__pf()
{
	bpf__ExecuteUbergraph_Playback_Actor__pf_5(11);
}
void APlayback_Actor_C__pf3621867267::bpf__Pause__pf()
{
	bpf__ExecuteUbergraph_Playback_Actor__pf_4(9);
}
void APlayback_Actor_C__pf3621867267::bpf__Begin__pf()
{
	bpf__ExecuteUbergraph_Playback_Actor__pf_3(16);
}
PRAGMA_DISABLE_OPTIMIZATION
void APlayback_Actor_C__pf3621867267::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APlayback_Actor_C__pf3621867267::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{227, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/MediaAssets.MediaSoundComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APlayback_Actor_C__pf3621867267
{
	FRegisterHelper__APlayback_Actor_C__pf3621867267()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Playback_Actor"), &APlayback_Actor_C__pf3621867267::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APlayback_Actor_C__pf3621867267 Instance;
};
FRegisterHelper__APlayback_Actor_C__pf3621867267 FRegisterHelper__APlayback_Actor_C__pf3621867267::Instance;
