...
AButtonPad_Blueprint_C__pf3730827578::AButtonPad_Blueprint_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AButtonPad_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AButtonPad_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__0->SetCollisionProfileName(FName(TEXT("NoCollision")));
		auto& __Local__2 = (*(AccessPrivateProperty<FVector >((__Local__0), USceneComponent::__PPO__RelativeScale3D() )));
		__Local__2 = FVector(0.171638, 0.618976, 0.051881);
	...
	bpv__Audio__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(AButtonPad_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__5)->SetPropertyValue_InContainer((bpv__Audio__pf), false, 0));
...
void AButtonPad_Blueprint_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AButtonPad_Blueprint_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((FBoolProperty*)__Local__10)->SetPropertyValue_InContainer((__Local__9), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void AButtonPad_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_ButtonPad_Blueprint__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsRight_Button_1__pf = Cast<ARightButton_C__pf2198246146>(b0l__CallFunc_Array_Get_Item_3__pf);
	b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsRight_Button_1__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsRight_Button_1__pf->bpv__ButtonOn__pf = true;
	}
	// optimized KCST_UnconditionalGoto
	(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, ALeftButton_C__pf2198246146::StaticClass(), /*out*/ TArrayCaster<ALeftButton_C__pf2198246146*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
	FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
	b0l__K2Node_DynamicCast_AsLeft_Button__pf = Cast<ALeftButton_C__pf2198246146>(b0l__CallFunc_Array_Get_Item__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsLeft_Button__pf != nullptr);;
...
void AButtonPad_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_ButtonPad_Blueprint__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 7);
	// optimized KCST_UnconditionalGoto
	(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Reset();
	UGameplayStatics::GetAllActorsOfClass(this, ARightButton_C__pf2198246146::StaticClass(), /*out*/ TArrayCaster<ARightButton_C__pf2198246146*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Get<AActor*>());
	...
	b0l__K2Node_DynamicCast_AsRight_Button__pf = Cast<ARightButton_C__pf2198246146>(b0l__CallFunc_Array_Get_Item_1__pf);
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsRight_Button__pf != nullptr);;
	...
	b0l__K2Node_DynamicCast_AsLeft_Button_1__pf = Cast<ALeftButton_C__pf2198246146>(b0l__CallFunc_Array_Get_Item_2__pf);
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsLeft_Button_1__pf != nullptr);;
...
void AButtonPad_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_ButtonPad_Blueprint__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(bpv__Audio__pf))
	{
		bpv__Audio__pf->UAudioComponent::StopDelayed(1.750000);
	}
	return; // KCST_GotoReturn
}
void AButtonPad_Blueprint_C__pf3730827578::bpf__RenableArrowButtonsByCancel__pf()
{
	bpf__ExecuteUbergraph_ButtonPad_Blueprint__pf_0(14);
}
void AButtonPad_Blueprint_C__pf3730827578::bpf__DisableArrowButtonsByBeginSpeech__pf()
{
	bpf__ExecuteUbergraph_ButtonPad_Blueprint__pf_1(7);
}
void AButtonPad_Blueprint_C__pf3730827578::bpf__PlayHummingByBeginButton__pf()
{
	bpf__ExecuteUbergraph_ButtonPad_Blueprint__pf_2(6);
}
PRAGMA_DISABLE_OPTIMIZATION
void AButtonPad_Blueprint_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AButtonPad_Blueprint_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AButtonPad_Blueprint_C__pf3730827578
{
	FRegisterHelper__AButtonPad_Blueprint_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/ButtonPad_Blueprint"), &AButtonPad_Blueprint_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AButtonPad_Blueprint_C__pf3730827578 Instance;
};
FRegisterHelper__AButtonPad_Blueprint_C__pf3730827578 FRegisterHelper__AButtonPad_Blueprint_C__pf3730827578::Instance;
