...
AResetButton2_Button_Blueprint_C__pf3730827578::AResetButton2_Button_Blueprint_C__pf3730827578(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AResetButton2_Button_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed));
		...
		__Local__3 = FVector(0.078770, 0.078770, 0.078770);
	...
	bpv__Audio__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(AResetButton2_Button_Blueprint_C__pf3730827578::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__6)->SetPropertyValue_InContainer((bpv__Audio__pf), false, 0));
	bpv__ButtonxOn__pfT = false;
	bpv__Credits__pf = false;
	auto& __Local__8 = (*(AccessPrivateProperty<UStaticMeshComponent*>((this), AStaticMeshActor::__PPO__StaticMeshComponent() )));
	__Local__8 = __Local__0;
...
void AResetButton2_Button_Blueprint_C__pf3730827578::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AResetButton2_Button_Blueprint_C__pf3730827578::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__14.ComponentPropertyName = FName(TEXT("StaticMeshComponent"));
	__Local__14.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__14.FunctionNameToBind = FName(TEXT("BndEvt__RightButton_StaticMeshComponent_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AResetButton2_Button_Blueprint_C__pf3730827578::bpf__ExecuteUbergraph_ResetButton2_Button_Blueprint__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, AResetButton2_Top_Blueprint_C__pf2552470103::StaticClass(), /*out*/ TArrayCaster<AResetButton2_Top_Blueprint_C__pf2552470103*>(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf).Get<AActor*>());
			}
		case 2:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_AsReset_Button_2_Top_Blueprint__pf = Cast<AResetButton2_Top_Blueprint_C__pf2552470103>(b0l__CallFunc_Array_Get_Item__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsReset_Button_2_Top_Blueprint__pf != nullptr);;
		...
		case 3:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsReset_Button_2_Top_Blueprint__pf->bpf__ButtonPress__pf();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 5:
			{
				...
				UKismetMathLibrary::BreakVector(b0l__CallFunc_BreakTransform_Location_1__pf, /*out*/ b0l__CallFunc_BreakVector_X_3__pf, /*out*/ b0l__CallFunc_BreakVector_Y_3__pf, /*out*/ b0l__CallFunc_BreakVector_Z_3__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(b0l__CallFunc_BreakVector_Z_3__pf, 3.000000);
				bpfv__CallFunc_MakeVector_ReturnValue_1__pf = UKismetMathLibrary::MakeVector(b0l__CallFunc_BreakVector_X_3__pf, b0l__CallFunc_BreakVector_Y_3__pf, bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf);
				bpfv__CallFunc_MakeTransform_ReturnValue_1__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_MakeVector_ReturnValue_1__pf, b0l__CallFunc_BreakTransform_Rotation_1__pf, b0l__CallFunc_BreakTransform_Scale_1__pf);
				if(::IsValid((*(AccessPrivateProperty<UStaticMeshComponent* >((this), AStaticMeshActor::__PPO__StaticMeshComponent() )))))
				{
		...
		case 8:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsProjector_Blueprint__pf))
				{
					b0l__K2Node_DynamicCast_AsProjector_Blueprint__pf->bpf__FadeInOnReset__pf();
				}
				__CurrentState = 1;
				break;
			}
		...
		case 15:
			{
				...
				bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(b0l__CallFunc_BreakVector_Z_2__pf, 3.000000);
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(b0l__CallFunc_BreakVector_X_2__pf, b0l__CallFunc_BreakVector_Y_2__pf, bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf);
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_MakeVector_ReturnValue__pf, b0l__CallFunc_BreakTransform_Rotation__pf, b0l__CallFunc_BreakTransform_Scale__pf);
				if(::IsValid((*(AccessPrivateProperty<UStaticMeshComponent* >((this), AStaticMeshActor::__PPO__StaticMeshComponent() )))))
				{
		...
		case 16:
			{
				...
				{
					bpv__Audio__pf->UAudioComponent::SetPitchMultiplier(0.750000);
				}
			}
		case 17:
			{
		...
		case 19:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpf__DeleteSpeechDataByResetButton__pf();
				}
			}
		case 20:
			{
				UKismetSystemLibrary::Delay(this, 0.350000, FLatentActionInfo(4, -1629109211, TEXT("ExecuteUbergraph_ResetButton2_Button_Blueprint_0"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void AResetButton2_Button_Blueprint_C__pf3730827578::bpf__BndEvt__RightButton_StaticMeshComponent_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_ResetButton2_Button_Blueprint__pf_0(9);
}
PRAGMA_DISABLE_OPTIMIZATION
void AResetButton2_Button_Blueprint_C__pf3730827578::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AResetButton2_Button_Blueprint_C__pf3730827578::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AResetButton2_Button_Blueprint_C__pf3730827578
{
	FRegisterHelper__AResetButton2_Button_Blueprint_C__pf3730827578()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Blueprints/ResetButton2_Button_Blueprint"), &AResetButton2_Button_Blueprint_C__pf3730827578::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AResetButton2_Button_Blueprint_C__pf3730827578 Instance;
};
FRegisterHelper__AResetButton2_Button_Blueprint_C__pf3730827578 FRegisterHelper__AResetButton2_Button_Blueprint_C__pf3730827578::Instance;
