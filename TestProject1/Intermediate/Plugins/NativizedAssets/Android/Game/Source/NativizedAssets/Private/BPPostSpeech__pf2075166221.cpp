...
ABPPostSpeech_C__pf2075166221::ABPPostSpeech_C__pf2075166221(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__2 = (*(AccessPrivateProperty<FIntPoint >((bpv__Widget__pf), UWidgetComponent::__PPO__DrawSize() )));
	__Local__2.X = 1920;
	__Local__2.Y = 1080;
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(-80.827850, 4.000000, 126.278587);
	auto& __Local__4 = (*(AccessPrivateProperty<FRotator >((bpv__Widget__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__4 = FRotator(40.000015, 0.000000, 0.000000);
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__Widget__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__5 = FVector(0.329329, 0.329329, 0.329329);
...
void ABPPostSpeech_C__pf2075166221::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABPPostSpeech_C__pf2075166221::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABPPostSpeech_C__pf2075166221::bpf__ExecuteUbergraph_BPPostSpeech__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	UGameplayStatics::GetAllActorsOfClass(this, ARecording_Test_1_C__pf1711902218::StaticClass(), /*out*/ TArrayCaster<ARecording_Test_1_C__pf1711902218*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf).Get<AActor*>());
	...
	b0l__K2Node_DynamicCast_AsRecording_Test_1__pf = Cast<ARecording_Test_1_C__pf1711902218>(b0l__CallFunc_Array_Get_Item_1__pf);
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsRecording_Test_1__pf != nullptr);;
	...
	float  __Local__7 = 0.000000;
	if(::IsValid(b0l__K2Node_DynamicCast_AsMenu_GI__pf))
	{
		b0l__K2Node_DynamicCast_AsMenu_GI__pf->bpv__DataxtoxSavexxxTotalxTimexTaken__pfTTT3TTT = ((::IsValid(b0l__K2Node_DynamicCast_AsRecording_Test_1__pf) && ::IsValid(b0l__K2Node_DynamicCast_AsRecording_Test_1__pf->bpv__TempRecording__pf)) ? (b0l__K2Node_DynamicCast_AsRecording_Test_1__pf->bpv__TempRecording__pf->Duration) : (__Local__7));
	}
...
void ABPPostSpeech_C__pf2075166221::bpf__ExecuteUbergraph_BPPostSpeech__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 12:
			{
				UKismetSystemLibrary::Delay(this, 0.200000, FLatentActionInfo(1, 10670506, TEXT("ExecuteUbergraph_BPPostSpeech_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void ABPPostSpeech_C__pf2075166221::bpf__UIPlayerCalledByStop__pf()
{
	bpf__ExecuteUbergraph_BPPostSpeech__pf_0(13);
}
void ABPPostSpeech_C__pf2075166221::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BPPostSpeech__pf_1(9);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABPPostSpeech_C__pf2075166221::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABPPostSpeech_C__pf2075166221::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABPPostSpeech_C__pf2075166221
{
	FRegisterHelper__ABPPostSpeech_C__pf2075166221()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Stutter_Speak_Content/Widgets/BPPostSpeech"), &ABPPostSpeech_C__pf2075166221::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABPPostSpeech_C__pf2075166221 Instance;
};
FRegisterHelper__ABPPostSpeech_C__pf2075166221 FRegisterHelper__ABPPostSpeech_C__pf2075166221::Instance;
